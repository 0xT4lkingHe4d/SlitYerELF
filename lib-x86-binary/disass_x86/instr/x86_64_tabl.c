...
__attribute__((section(".x86_64_tabl"), aligned(0x1000))) const instr x86_64_tabl[941] = (const instr[941]){
	{ .opcode1=0x00, .reg_op='r', .mnemonic="ADD", .op={ {.f=F_ADDR_E | F_OPER_B}, {.f=F_ADDR_G | F_OPER_B}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Add */
	{ .opcode1=0x01, .reg_op='r', .mnemonic="ADD", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_G | F_OPER_VQP}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Add */
	{ .opcode1=0x02, .reg_op='r', .mnemonic="ADD", .op={ {.f=F_ADDR_G | F_OPER_B}, {.f=F_ADDR_E | F_OPER_B}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Add */
	{ .opcode1=0x03, .reg_op='r', .mnemonic="ADD", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Add */
	{ .opcode1=0x04, .mnemonic="ADD", .op={ {.reg="AL"}, {.f=F_ADDR_I | F_OPER_B}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Add */
	{ .opcode1=0x05, .mnemonic="ADD", .op={ {.reg="rAX"}, {.f=F_ADDR_I | F_OPER_VDS}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Add */
	{ .opcode1=0x06, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Invalid Instruction in 64-Bit Mode */
	{ .opcode1=0x07, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Invalid Instruction in 64-Bit Mode */
	{ .opcode1=0x08, .reg_op='r', .mnemonic="OR", .op={ {.f=F_ADDR_E | F_OPER_B}, {.f=F_ADDR_G | F_OPER_B}, 0, 0}, },            /* desc=Logical Inclusive OR */
	{ .opcode1=0x09, .reg_op='r', .mnemonic="OR", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_G | F_OPER_VQP}, 0, 0}, },            /* desc=Logical Inclusive OR */
	{ .opcode1=0x0A, .reg_op='r', .mnemonic="OR", .op={ {.f=F_ADDR_G | F_OPER_B}, {.f=F_ADDR_E | F_OPER_B}, 0, 0}, },            /* desc=Logical Inclusive OR */
	{ .opcode1=0x0B, .reg_op='r', .mnemonic="OR", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0}, },            /* desc=Logical Inclusive OR */
	{ .opcode1=0x0C, .mnemonic="OR", .op={ {.reg="AL"}, {.f=F_ADDR_I | F_OPER_B}, 0, 0}, },            /* desc=Logical Inclusive OR */
	{ .opcode1=0x0D, .mnemonic="OR", .op={ {.reg="rAX"}, {.f=F_ADDR_I | F_OPER_VDS}, 0, 0}, },            /* desc=Logical Inclusive OR */
	{ .opcode1=0x0E, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Invalid Instruction in 64-Bit Mode */
	...
	{ .opcode1=0x11, .reg_op='r', .mnemonic="ADC", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_G | F_OPER_VQP}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Add with Carry */
	...
	{ .opcode1=0x13, .reg_op='r', .mnemonic="ADC", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Add with Carry */
	{ .opcode1=0x14, .mnemonic="ADC", .op={ {.reg="AL"}, {.f=F_ADDR_I | F_OPER_B}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Add with Carry */
	{ .opcode1=0x15, .mnemonic="ADC", .op={ {.reg="rAX"}, {.f=F_ADDR_I | F_OPER_VDS}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Add with Carry */
	{ .opcode1=0x16, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Invalid Instruction in 64-Bit Mode */
	{ .opcode1=0x17, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Invalid Instruction in 64-Bit Mode */
	...
	{ .opcode1=0x19, .reg_op='r', .mnemonic="SBB", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_G | F_OPER_VQP}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Integer Subtraction with Borrow */
	...
	{ .opcode1=0x1B, .reg_op='r', .mnemonic="SBB", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Integer Subtraction with Borrow */
	...
	{ .opcode1=0x1D, .mnemonic="SBB", .op={ {.reg="rAX"}, {.f=F_ADDR_I | F_OPER_VDS}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Integer Subtraction with Borrow */
	{ .opcode1=0x1E, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Invalid Instruction in 64-Bit Mode */
	{ .opcode1=0x1F, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Invalid Instruction in 64-Bit Mode */
	{ .opcode1=0x20, .reg_op='r', .mnemonic="AND", .op={ {.f=F_ADDR_E | F_OPER_B}, {.f=F_ADDR_G | F_OPER_B}, 0, 0}, },            /* desc=Logical AND */
	{ .opcode1=0x21, .reg_op='r', .mnemonic="AND", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_G | F_OPER_VQP}, 0, 0}, },            /* desc=Logical AND */
	{ .opcode1=0x22, .reg_op='r', .mnemonic="AND", .op={ {.f=F_ADDR_G | F_OPER_B}, {.f=F_ADDR_E | F_OPER_B}, 0, 0}, },            /* desc=Logical AND */
	{ .opcode1=0x23, .reg_op='r', .mnemonic="AND", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0}, },            /* desc=Logical AND */
	{ .opcode1=0x24, .mnemonic="AND", .op={ {.reg="AL"}, {.f=F_ADDR_I | F_OPER_B}, 0, 0}, },            /* desc=Logical AND */
	{ .opcode1=0x25, .mnemonic="AND", .op={ {.reg="rAX"}, {.f=F_ADDR_I | F_OPER_VDS}, 0, 0}, },            /* desc=Logical AND */
	{ .prefix=0x26, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Null Prefix in 64-bit Mode */
	{ .opcode1=0x27, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Invalid Instruction in 64-Bit Mode */
	{ .opcode1=0x28, .reg_op='r', .mnemonic="SUB", .op={ {.f=F_ADDR_E | F_OPER_B}, {.f=F_ADDR_G | F_OPER_B}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Subtract */
	{ .opcode1=0x29, .reg_op='r', .mnemonic="SUB", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_G | F_OPER_VQP}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Subtract */
	{ .opcode1=0x2A, .reg_op='r', .mnemonic="SUB", .op={ {.f=F_ADDR_G | F_OPER_B}, {.f=F_ADDR_E | F_OPER_B}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Subtract */
	{ .opcode1=0x2B, .reg_op='r', .mnemonic="SUB", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Subtract */
	{ .opcode1=0x2C, .mnemonic="SUB", .op={ {.reg="AL"}, {.f=F_ADDR_I | F_OPER_B}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Subtract */
	{ .opcode1=0x2D, .mnemonic="SUB", .op={ {.reg="rAX"}, {.f=F_ADDR_I | F_OPER_VDS}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Subtract */
	{ .prefix=0x2E, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Null Prefix in 64-bit Mode */
	{ .opcode1=0x2F, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Invalid Instruction in 64-Bit Mode */
	{ .opcode1=0x30, .reg_op='r', .mnemonic="XOR", .op={ {.f=F_ADDR_E | F_OPER_B}, {.f=F_ADDR_G | F_OPER_B}, 0, 0}, },            /* desc=Logical Exclusive OR */
	{ .opcode1=0x31, .reg_op='r', .mnemonic="XOR", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_G | F_OPER_VQP}, 0, 0}, },            /* desc=Logical Exclusive OR */
	{ .opcode1=0x32, .reg_op='r', .mnemonic="XOR", .op={ {.f=F_ADDR_G | F_OPER_B}, {.f=F_ADDR_E | F_OPER_B}, 0, 0}, },            /* desc=Logical Exclusive OR */
	{ .opcode1=0x33, .reg_op='r', .mnemonic="XOR", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0}, },            /* desc=Logical Exclusive OR */
	{ .opcode1=0x34, .mnemonic="XOR", .op={ {.reg="AL"}, {.f=F_ADDR_I | F_OPER_B}, 0, 0}, },            /* desc=Logical Exclusive OR */
	{ .opcode1=0x35, .mnemonic="XOR", .op={ {.reg="rAX"}, {.f=F_ADDR_I | F_OPER_VDS}, 0, 0}, },            /* desc=Logical Exclusive OR */
	{ .prefix=0x36, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Null Prefix in 64-bit Mode */
	{ .opcode1=0x37, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Invalid Instruction in 64-Bit Mode */
	...
	{ .opcode1=0x39, .reg_op='r', .mnemonic="CMP", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_G | F_OPER_VQP}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Compare Two Operands */
	...
	{ .opcode1=0x3B, .reg_op='r', .mnemonic="CMP", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Compare Two Operands */
	{ .opcode1=0x3C, .mnemonic="CMP", .op={ {.reg="AL"}, {.f=F_ADDR_I | F_OPER_B}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Compare Two Operands */
	{ .opcode1=0x3D, .mnemonic="CMP", .op={ {.reg="rAX"}, {.f=F_ADDR_I | F_OPER_VDS}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Compare Two Operands */
	{ .prefix=0x3E, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Null Prefix in 64-bit Mode */
	{ .opcode1=0x3F, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Invalid Instruction in 64-Bit Mode */
	{ .prefix=0x40, .m=MODOP_E, .mnemonic="REX", .op={ 0, 0, 0, 0}, },            /* desc=Access to new 8-bit registers */
	{ .prefix=0x41, .m=MODOP_E, .mnemonic="REX.B", .op={ 0, 0, 0, 0}, },            /* desc=Extension of r/m field, base field, or opcode reg field */
	{ .prefix=0x42, .m=MODOP_E, .mnemonic="REX.X", .op={ 0, 0, 0, 0}, },            /* desc=Extension of SIB index field */
	{ .prefix=0x43, .m=MODOP_E, .mnemonic="REX.XB", .op={ 0, 0, 0, 0}, },            /* desc=REX.X and REX.B combination */
	{ .prefix=0x44, .m=MODOP_E, .mnemonic="REX.R", .op={ 0, 0, 0, 0}, },            /* desc=Extension of ModR/M reg field */
	{ .prefix=0x45, .m=MODOP_E, .mnemonic="REX.RB", .op={ 0, 0, 0, 0}, },            /* desc=REX.R and REX.B combination */
	{ .prefix=0x46, .m=MODOP_E, .mnemonic="REX.RX", .op={ 0, 0, 0, 0}, },            /* desc=REX.R and REX.X combination */
	{ .prefix=0x47, .m=MODOP_E, .mnemonic="REX.RXB", .op={ 0, 0, 0, 0}, },            /* desc=REX.R, REX.X and REX.B combination */
	{ .prefix=0x48, .m=MODOP_E, .mnemonic="REX.W", .op={ 0, 0, 0, 0}, },            /* desc=64 Bit Operand Size */
	{ .prefix=0x49, .m=MODOP_E, .mnemonic="REX.WB", .op={ 0, 0, 0, 0}, },            /* desc=REX.W and REX.B combination */
	{ .prefix=0x4A, .m=MODOP_E, .mnemonic="REX.WX", .op={ 0, 0, 0, 0}, },            /* desc=REX.W and REX.X combination */
	{ .prefix=0x4B, .m=MODOP_E, .mnemonic="REX.WXB", .op={ 0, 0, 0, 0}, },            /* desc=REX.W, REX.X and REX.B combination */
	{ .prefix=0x4C, .m=MODOP_E, .mnemonic="REX.WR", .op={ 0, 0, 0, 0}, },            /* desc=REX.W and REX.R combination */
	{ .prefix=0x4D, .m=MODOP_E, .mnemonic="REX.WRB", .op={ 0, 0, 0, 0}, },            /* desc=REX.W, REX.R and REX.B combination */
	{ .prefix=0x4E, .m=MODOP_E, .mnemonic="REX.WRX", .op={ 0, 0, 0, 0}, },            /* desc=REX.W, REX.R and REX.X combination */
	{ .prefix=0x4F, .m=MODOP_E, .mnemonic="REX.WRXB", .op={ 0, 0, 0, 0}, },            /* desc=REX.W, REX.R, REX.X and REX.B combination */
	{ .opcode1=0x50, .flds=1, .m=MODOP_E, .mnemonic="PUSH", .op={ {.f=F_ADDR_Z | F_OPER_VQ}, 0, 0, 0}, },            /* desc=Push Word, Doubleword or Quadword Onto the Stack */
	{ .opcode1=0x58, .flds=1, .m=MODOP_E, .mnemonic="POP", .op={ {.f=F_ADDR_Z | F_OPER_VQ}, 0, 0, 0}, },            /* desc=Pop a Value from the Stack */
	{ .opcode1=0x60, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Invalid Instruction in 64-Bit Mode */
	{ .opcode1=0x61, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Invalid Instruction in 64-Bit Mode */
	{ .opcode1=0x62, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Invalid Instruction in 64-Bit Mode */
	{ .opcode1=0x63, .reg_op='r', .m=MODOP_E, .mnemonic="MOVSXD", .op={ {.f=F_ADDR_G | F_OPER_DQP}, {.f=F_ADDR_E | F_OPER_D}, 0, 0}, },            /* desc=Move with Sign-Extension */
	...
	{ .opcode1=0x69, .reg_op='r', .mnemonic="IMUL", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_VDS}, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Signed Multiply */
	{ .opcode1=0x6A, .mnemonic="PUSH", .op={ {.f=F_ADDR_I | F_OPER_BSS}, 0, 0, 0}, },            /* desc=Push Word, Doubleword or Quadword Onto the Stack */
	{ .opcode1=0x6B, .reg_op='r', .mnemonic="IMUL", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_BS}, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Signed Multiply */
	...
	{ .opcode1=0x81, .reg_op='0', .mnemonic="ADD", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_VDS}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Add */
	{ .opcode1=0x81, .reg_op=1, .mnemonic="OR", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_VDS}, 0, 0}, },            /* desc=Logical Inclusive OR */
	{ .opcode1=0x81, .reg_op=2, .mnemonic="ADC", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_VDS}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Add with Carry */
	{ .opcode1=0x81, .reg_op=3, .mnemonic="SBB", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_VDS}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Integer Subtraction with Borrow */
	{ .opcode1=0x81, .reg_op=4, .mnemonic="AND", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_VDS}, 0, 0}, },            /* desc=Logical AND */
	{ .opcode1=0x81, .reg_op=5, .mnemonic="SUB", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_VDS}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Subtract */
	{ .opcode1=0x81, .reg_op=6, .mnemonic="XOR", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_VDS}, 0, 0}, },            /* desc=Logical Exclusive OR */
	{ .opcode1=0x81, .reg_op=7, .mnemonic="CMP", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_VDS}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Compare Two Operands */
	{ .opcode1=0x82, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Invalid Instruction in 64-Bit Mode */
	{ .opcode1=0x83, .reg_op='0', .mnemonic="ADD", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_BS}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Add */
	{ .opcode1=0x83, .reg_op=1, .mnemonic="OR", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_BS}, 0, 0}, },            /* desc=Logical Inclusive OR */
	{ .opcode1=0x83, .reg_op=2, .mnemonic="ADC", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_BS}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Add with Carry */
	{ .opcode1=0x83, .reg_op=3, .mnemonic="SBB", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_BS}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Integer Subtraction with Borrow */
	{ .opcode1=0x83, .reg_op=4, .mnemonic="AND", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_BS}, 0, 0}, },            /* desc=Logical AND */
	{ .opcode1=0x83, .reg_op=5, .mnemonic="SUB", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_BS}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Subtract */
	{ .opcode1=0x83, .reg_op=6, .mnemonic="XOR", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_BS}, 0, 0}, },            /* desc=Logical Exclusive OR */
	{ .opcode1=0x83, .reg_op=7, .mnemonic="CMP", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_BS}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Compare Two Operands */
	{ .opcode1=0x84, .reg_op='r', .mnemonic="TEST", .op={ {.f=F_ADDR_E | F_OPER_B}, {.f=F_ADDR_G | F_OPER_B}, 0, 0}, },            /* desc=Logical Compare */
	{ .opcode1=0x85, .reg_op='r', .mnemonic="TEST", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_G | F_OPER_VQP}, 0, 0}, },            /* desc=Logical Compare */
	...
	{ .opcode1=0x87, .reg_op='r', .mnemonic="XCHG", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0}, },            /* desc=Exchange Register/Memory with Register */
	{ .opcode1=0x88, .reg_op='r', .mnemonic="MOV", .op={ {.f=F_ADDR_E | F_OPER_B}, {.f=F_ADDR_G | F_OPER_B}, 0, 0}, },            /* desc=Move */
	{ .opcode1=0x89, .reg_op='r', .mnemonic="MOV", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_G | F_OPER_VQP}, 0, 0}, },            /* desc=Move */
	{ .opcode1=0x8A, .reg_op='r', .mnemonic="MOV", .op={ {.f=F_ADDR_G | F_OPER_B}, {.f=F_ADDR_E | F_OPER_B}, 0, 0}, },            /* desc=Move */
	{ .opcode1=0x8B, .reg_op='r', .mnemonic="MOV", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0}, },            /* desc=Move */
	{ .opcode1=0x8C, .reg_op='r', .ops=(x86_in_ops[]){ { .mnemonic="MOV", .op={ {.f=F_ADDR_M | F_OPER_W}, {.f=F_ADDR_S | F_OPER_W}, 0, 0 }, }, { .mnemonic="MOV", .op={ {.f=F_ADDR_R | F_OPER_VQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Move */
	{ .opcode1=0x8D, .reg_op='r', .mnemonic="LEA", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_M}, 0, 0}, },            /* desc=Load Effective Address */
	...
	{ .opcode1=0x8F, .reg_op='0', .m=MODOP_E, .mnemonic="POP", .op={ {.f=F_ADDR_E | F_OPER_VQ}, 0, 0, 0}, },            /* desc=Pop a Value from the Stack */
	{ .opcode1=0x90, .flds=1, .mnemonic="XCHG", .op={ {.f=F_ADDR_Z | F_OPER_VQP}, {.reg="rAX"}, 0, 0}, },            /* desc=Exchange Register/Memory with Register */
	...
	{ .opcode1=0x98, .m=MODOP_E, .ops=(x86_in_ops[]){ { .mnemonic="CBW", .op={ {.reg="AX"}, {.reg="AL"}, 0, 0 }, }, { .mnemonic="CWDE", .op={ {.reg="EAX"}, {.reg="AX"}, 0, 0 }, }, { .mnemonic="CDQE", .op={ {.reg="RAX"}, {.reg="EAX"}, 0, 0 }, },  }, .ops_count=3,  },            /* desc=Convert */
	{ .opcode1=0x99, .m=MODOP_E, .ops=(x86_in_ops[]){ { .mnemonic="CWD", .op={ {.reg="DX"}, {.reg="AX"}, 0, 0 }, }, { .mnemonic="CDQ", .op={ {.reg="EDX"}, {.reg="EAX"}, 0, 0 }, }, { .mnemonic="CQO", .op={ {.reg="RDX"}, {.reg="RAX"}, 0, 0 }, },  }, .ops_count=3,  },            /* desc=Convert */
	{ .opcode1=0x9A, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Invalid Instruction in 64-Bit Mode */
	...
	{ .opcode1=0x9C, .m=MODOP_E, .ops=(x86_in_ops[]){ { .mnemonic="PUSHF", .op={ {.f=F_ADDR_F | F_OPER_WS}, 0, 0, 0 }, }, { .mnemonic="PUSHFQ", .op={ {.f=F_ADDR_F | F_OPER_QS}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Push rFLAGS Register onto the Stack */
	{ .opcode1=0x9D, .m=MODOP_E, .ops=(x86_in_ops[]){ { .mnemonic="POPF", .op={ {.f=F_ADDR_F | F_OPER_WS}, 0, 0, 0 }, }, { .mnemonic="POPFQ", .op={ {.f=F_ADDR_F | F_OPER_QS}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Pop Stack into rFLAGS Register */
	...
	{ .opcode1=0xA1, .mnemonic="MOV", .op={ {.reg="rAX"}, {.f=F_ADDR_O | F_OPER_VQP}, 0, 0}, },            /* desc=Move */
	{ .opcode1=0xA2, .mnemonic="MOV", .op={ {.f=F_ADDR_O | F_OPER_B}, {.reg="AL"}, 0, 0}, },            /* desc=Move */
	{ .opcode1=0xA3, .mnemonic="MOV", .op={ {.f=F_ADDR_O | F_OPER_VQP}, {.reg="rAX"}, 0, 0}, },            /* desc=Move */
	...
	{ .opcode1=0xA5, .m=MODOP_E, .ops=(x86_in_ops[]){ { .mnemonic="MOVS", .op={ {.f=F_ADDR_Y | F_OPER_VQP}, {.f=F_ADDR_X | F_OPER_VQP}, 0, 0 }, }, { .mnemonic="MOVSW", .op={ {.f=F_ADDR_Y | F_OPER_WO}, {.f=F_ADDR_X | F_OPER_WO}, 0, 0 }, }, { .mnemonic="MOVSD", .op={ {.f=F_ADDR_Y | F_OPER_DO}, {.f=F_ADDR_X | F_OPER_DO}, 0, 0 }, }, { .mnemonic="MOVSQ", .op={ {.f=F_ADDR_Y | F_OPER_QP}, {.f=F_ADDR_X | F_OPER_QP}, 0, 0 }, },  }, .ops_count=4,  },            /* desc=Move Data from String to String */
	...
	{ .opcode1=0xA7, .m=MODOP_E, .ops=(x86_in_ops[]){ { .mnemonic="CMPS", .op={ {.f=F_ADDR_Y | F_OPER_VQP}, {.f=F_ADDR_X | F_OPER_VQP}, 0, 0 }, }, { .mnemonic="CMPSW", .op={ {.f=F_ADDR_Y | F_OPER_WO}, {.f=F_ADDR_X | F_OPER_WO}, 0, 0 }, }, { .mnemonic="CMPSD", .op={ {.f=F_ADDR_Y | F_OPER_DO}, {.f=F_ADDR_X | F_OPER_DO}, 0, 0 }, }, { .mnemonic="CMPSQ", .op={ {.f=F_ADDR_Y | F_OPER_QP}, {.f=F_ADDR_X | F_OPER_QP}, 0, 0 }, },  }, .ops_count=4,  },            /* desc=Compare String Operands */
	{ .opcode1=0xA8, .mnemonic="TEST", .op={ {.reg="AL"}, {.f=F_ADDR_I | F_OPER_B}, 0, 0}, },            /* desc=Logical Compare */
	{ .opcode1=0xA9, .mnemonic="TEST", .op={ {.reg="rAX"}, {.f=F_ADDR_I | F_OPER_VDS}, 0, 0}, },            /* desc=Logical Compare */
	...
	{ .opcode1=0xAB, .m=MODOP_E, .ops=(x86_in_ops[]){ { .mnemonic="STOS", .op={ {.f=F_ADDR_Y | F_OPER_VQP}, {.reg="rAX"}, 0, 0 }, }, { .mnemonic="STOSW", .op={ {.f=F_ADDR_Y | F_OPER_WO}, {.reg="AX"}, 0, 0 }, }, { .mnemonic="STOSD", .op={ {.f=F_ADDR_Y | F_OPER_DO}, {.reg="EAX"}, 0, 0 }, }, { .mnemonic="STOSQ", .op={ {.f=F_ADDR_Y | F_OPER_QP}, {.reg="RAX"}, 0, 0 }, },  }, .ops_count=4,  },            /* desc=Store String */
	...
	{ .opcode1=0xAD, .m=MODOP_E, .ops=(x86_in_ops[]){ { .mnemonic="LODS", .op={ {.reg="rAX"}, {.f=F_ADDR_X | F_OPER_VQP}, 0, 0 }, }, { .mnemonic="LODSW", .op={ {.reg="AX"}, {.f=F_ADDR_X | F_OPER_WO}, 0, 0 }, }, { .mnemonic="LODSD", .op={ {.reg="EAX"}, {.f=F_ADDR_X | F_OPER_DO}, 0, 0 }, }, { .mnemonic="LODSQ", .op={ {.reg="RAX"}, {.f=F_ADDR_X | F_OPER_QP}, 0, 0 }, },  }, .ops_count=4,  },            /* desc=Load String */
	...
	{ .opcode1=0xAF, .m=MODOP_E, .ops=(x86_in_ops[]){ { .mnemonic="SCAS", .op={ {.f=F_ADDR_Y | F_OPER_VQP}, {.reg="rAX"}, 0, 0 }, }, { .mnemonic="SCASW", .op={ {.f=F_ADDR_Y | F_OPER_WO}, {.reg="AX"}, 0, 0 }, }, { .mnemonic="SCASD", .op={ {.f=F_ADDR_Y | F_OPER_DO}, {.reg="EAX"}, 0, 0 }, }, { .mnemonic="SCASQ", .op={ {.f=F_ADDR_Y | F_OPER_QP}, {.reg="RAX"}, 0, 0 }, },  }, .ops_count=4,  },            /* desc=Scan String */
	{ .opcode1=0xB0, .flds=1, .mnemonic="MOV", .op={ {.f=F_ADDR_Z | F_OPER_B}, {.f=F_ADDR_I | F_OPER_B}, 0, 0}, },            /* desc=Move */
	{ .opcode1=0xB8, .flds=1, .mnemonic="MOV", .op={ {.f=F_ADDR_Z | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_VQP}, 0, 0}, },            /* desc=Move */
	...
	{ .opcode1=0xC1, .reg_op='0', .mnemonic="ROL", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_B}, 0, 0}, },            /* desc=Rotate */
	{ .opcode1=0xC1, .reg_op=1, .mnemonic="ROR", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_B}, 0, 0}, },            /* desc=Rotate */
	{ .opcode1=0xC1, .reg_op=2, .mnemonic="RCL", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_B}, 0, 0}, },            /* desc=Rotate */
	{ .opcode1=0xC1, .reg_op=3, .mnemonic="RCR", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_B}, 0, 0}, },            /* desc=Rotate */
	{ .opcode1=0xC1, .reg_op=4, .ops=(x86_in_ops[]){ { .mnemonic="SHL", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_B}, 0, 0 }, }, { .mnemonic="SAL", .op={ {.f=F_ADDR_E | F_OPER_VQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Shift */
	{ .opcode1=0xC1, .reg_op=5, .mnemonic="SHR", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_B}, 0, 0}, },            /* desc=Shift */
	{ .opcode1=0xC1, .reg_op=6, .ops=(x86_in_ops[]){ { .mnemonic="SAL", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_B}, 0, 0 }, }, { .mnemonic="SHL", .op={ {.f=F_ADDR_E | F_OPER_VQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Shift */
	{ .opcode1=0xC1, .reg_op=7, .mnemonic="SAR", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_B}, 0, 0}, },            /* desc=Shift */
	...
	{ .opcode1=0xC4, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Invalid Instruction in 64-Bit Mode */
	{ .opcode1=0xC5, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Invalid Instruction in 64-Bit Mode */
	{ .opcode1=0xC6, .reg_op='0', .mnemonic="MOV", .op={ {.f=F_ADDR_E | F_OPER_B}, {.f=F_ADDR_I | F_OPER_B}, 0, 0}, },            /* desc=Move */
	{ .opcode1=0xC7, .reg_op='0', .mnemonic="MOV", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_VDS}, 0, 0}, },            /* desc=Move */
	{ .opcode1=0xC8, .m=MODOP_E, .mnemonic="ENTER", .op={ {.reg="rBP"}, {.f=F_ADDR_I | F_OPER_W}, {.f=F_ADDR_I | F_OPER_B}, 0}, },            /* desc=Make Stack Frame for Procedure Parameters */
	{ .opcode1=0xC9, .m=MODOP_E, .mnemonic="LEAVE", .op={ {.reg="rBP"}, 0, 0, 0}, },            /* desc=High Level Procedure Exit */
	...
	{ .opcode1=0xCF, .m=MODOP_E, .ops=(x86_in_ops[]){ { .mnemonic="IRET", .op={ {.f=F_ADDR_F | F_OPER_WO}, 0, 0, 0 }, }, { .mnemonic="IRETD", .op={ {.f=F_ADDR_F | F_OPER_DO}, 0, 0, 0 }, }, { .mnemonic="IRETQ", .op={ {.f=F_ADDR_F | F_OPER_QP}, 0, 0, 0 }, },  }, .ops_count=3,  },            /* desc=Interrupt Return */
	...
	{ .opcode1=0xD1, .reg_op='0', .mnemonic="ROL", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.v=1}, 0, 0}, },            /* desc=Rotate */
	{ .opcode1=0xD1, .reg_op=1, .mnemonic="ROR", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.v=1}, 0, 0}, },            /* desc=Rotate */
	{ .opcode1=0xD1, .reg_op=2, .mnemonic="RCL", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.v=1}, 0, 0}, },            /* desc=Rotate */
	{ .opcode1=0xD1, .reg_op=3, .mnemonic="RCR", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.v=1}, 0, 0}, },            /* desc=Rotate */
	{ .opcode1=0xD1, .reg_op=4, .ops=(x86_in_ops[]){ { .mnemonic="SHL", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.v=1}, 0, 0 }, }, { .mnemonic="SAL", .op={ {.f=F_ADDR_E | F_OPER_VQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Shift */
	{ .opcode1=0xD1, .reg_op=5, .mnemonic="SHR", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.v=1}, 0, 0}, },            /* desc=Shift */
	{ .opcode1=0xD1, .reg_op=6, .ops=(x86_in_ops[]){ { .mnemonic="SAL", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.v=1}, 0, 0 }, }, { .mnemonic="SHL", .op={ {.f=F_ADDR_E | F_OPER_VQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Shift */
	{ .opcode1=0xD1, .reg_op=7, .mnemonic="SAR", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.v=1}, 0, 0}, },            /* desc=Shift */
	...
	{ .opcode1=0xD3, .reg_op='0', .mnemonic="ROL", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.reg="CL"}, 0, 0}, },            /* desc=Rotate */
	{ .opcode1=0xD3, .reg_op=1, .mnemonic="ROR", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.reg="CL"}, 0, 0}, },            /* desc=Rotate */
	{ .opcode1=0xD3, .reg_op=2, .mnemonic="RCL", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.reg="CL"}, 0, 0}, },            /* desc=Rotate */
	{ .opcode1=0xD3, .reg_op=3, .mnemonic="RCR", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.reg="CL"}, 0, 0}, },            /* desc=Rotate */
	{ .opcode1=0xD3, .reg_op=4, .ops=(x86_in_ops[]){ { .mnemonic="SHL", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.reg="CL"}, 0, 0 }, }, { .mnemonic="SAL", .op={ {.f=F_ADDR_E | F_OPER_VQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Shift */
	{ .opcode1=0xD3, .reg_op=5, .mnemonic="SHR", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.reg="CL"}, 0, 0}, },            /* desc=Shift */
	{ .opcode1=0xD3, .reg_op=6, .ops=(x86_in_ops[]){ { .mnemonic="SAL", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.reg="CL"}, 0, 0 }, }, { .mnemonic="SHL", .op={ {.f=F_ADDR_E | F_OPER_VQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Shift */
	{ .opcode1=0xD3, .reg_op=7, .mnemonic="SAR", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.reg="CL"}, 0, 0}, },            /* desc=Shift */
	{ .opcode1=0xD4, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Invalid Instruction in 64-Bit Mode */
	{ .opcode1=0xD5, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Invalid Instruction in 64-Bit Mode */
	{ .opcode1=0xD6, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Invalid Instruction in 64-Bit Mode */
	...
	{ .opcode1=0xE2, .m=MODOP_E, .mnemonic="LOOP", .op={ {.reg="rCX"}, {.f=F_ADDR_J | F_OPER_BS}, 0, 0}, .grp=GRP(GEN, BRANCH, COND),  },            /* desc=Decrement count; Jump short if count!=0 */
	{ .opcode1=0xE3, .m=MODOP_E, .ops=(x86_in_ops[]){ { .mnemonic="JECXZ", .op={ {.f=F_ADDR_J | F_OPER_BS}, {.reg="ECX"}, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), }, { .mnemonic="JRCXZ", .op={ {.f=F_ADDR_J | F_OPER_BS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), },  }, .ops_count=2,  },            /* desc=Jump short if rCX register is 0 */
	...
	{ .opcode1=0xE8, .mnemonic="CALL", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0}, },            /* desc=Call Procedure */
	{ .opcode1=0xE9, .mnemonic="JMP", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0}, },            /* desc=Jump */
	{ .opcode1=0xEA, .m=MODOP_E, .op={ 0, 0, 0, 0}, },            /* desc=Invalid Instruction in 64-Bit Mode */
	...
	{ .prefix=0xF2, .m=MODOP_E, .ops=(x86_in_ops[]){ { .mnemonic="REPNZ", .op={ {.reg="rCX"}, 0, 0, 0 }, }, { .mnemonic="REPNE", .op={ {.reg="rCX"}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Repeat String Operation Prefix */
	{ .prefix=0xF2, .m=MODOP_E, .mnemonic="REP", .op={ {.reg="rCX"}, 0, 0, 0}, },            /* desc=Repeat String Operation Prefix */
	{ .prefix=0xF2, .op={ 0, 0, 0, 0}, },            /* desc=Scalar Double-precision Prefix */
	{ .prefix=0xF3, .m=MODOP_E, .ops=(x86_in_ops[]){ { .mnemonic="REPZ", .op={ {.reg="rCX"}, 0, 0, 0 }, }, { .mnemonic="REPE", .op={ {.reg="rCX"}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Repeat String Operation Prefix */
	{ .prefix=0xF3, .m=MODOP_E, .mnemonic="REP", .op={ {.reg="rCX"}, 0, 0, 0}, },            /* desc=Repeat String Operation Prefix */
	...
	{ .opcode1=0xF7, .reg_op='0', .mnemonic="TEST", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_VDS}, 0, 0}, },            /* desc=Logical Compare */
	{ .opcode1=0xF7, .reg_op=1, .mnemonic="TEST", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_VDS}, 0, 0}, },            /* desc=Logical Compare */
	{ .opcode1=0xF7, .reg_op=2, .mnemonic="NOT", .op={ {.f=F_ADDR_E | F_OPER_VQP}, 0, 0, 0}, },            /* desc=One's Complement Negation */
	{ .opcode1=0xF7, .reg_op=3, .mnemonic="NEG", .op={ {.f=F_ADDR_E | F_OPER_VQP}, 0, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Two's Complement Negation */
	{ .opcode1=0xF7, .reg_op=4, .mnemonic="MUL", .op={ {.reg="rDX"}, {.reg="rAX"}, {.f=F_ADDR_E | F_OPER_VQP}, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Unsigned Multiply */
	{ .opcode1=0xF7, .reg_op=5, .mnemonic="IMUL", .op={ {.reg="rDX"}, {.reg="rAX"}, {.f=F_ADDR_E | F_OPER_VQP}, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Signed Multiply */
	{ .opcode1=0xF7, .reg_op=6, .mnemonic="DIV", .op={ {.reg="rDX"}, {.reg="rAX"}, {.f=F_ADDR_E | F_OPER_VQP}, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Unsigned Divide */
	{ .opcode1=0xF7, .reg_op=7, .mnemonic="IDIV", .op={ {.reg="rDX"}, {.reg="rAX"}, {.f=F_ADDR_E | F_OPER_VQP}, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Signed Divide */
	...
	{ .opcode1=0xFF, .reg_op='0', .mnemonic="INC", .op={ {.f=F_ADDR_E | F_OPER_VQP}, 0, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Increment by 1 */
	{ .opcode1=0xFF, .reg_op=1, .mnemonic="DEC", .op={ {.f=F_ADDR_E | F_OPER_VQP}, 0, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Decrement by 1 */
	{ .opcode1=0xFF, .reg_op=2, .mnemonic="CALL", .op={ {.f=F_ADDR_E | F_OPER_V}, 0, 0, 0}, },            /* desc=Call Procedure */
	{ .opcode1=0xFF, .reg_op=2, .m=MODOP_E, .mnemonic="CALL", .op={ {.f=F_ADDR_E | F_OPER_Q}, 0, 0, 0}, },            /* desc=Call Procedure */
	{ .opcode1=0xFF, .reg_op=3, .mnemonic="CALLF", .op={ {.f=F_ADDR_M | F_OPER_PTP}, 0, 0, 0}, },            /* desc=Call Procedure */
	{ .opcode1=0xFF, .reg_op=4, .mnemonic="JMP", .op={ {.f=F_ADDR_E | F_OPER_V}, 0, 0, 0}, },            /* desc=Jump */
	{ .opcode1=0xFF, .reg_op=4, .m=MODOP_E, .mnemonic="JMP", .op={ {.f=F_ADDR_E | F_OPER_Q}, 0, 0, 0}, },            /* desc=Jump */
	{ .opcode1=0xFF, .reg_op=5, .mnemonic="JMPF", .op={ {.f=F_ADDR_M | F_OPER_PTP}, 0, 0, 0}, },            /* desc=Jump */
	{ .opcode1=0xFF, .reg_op=6, .mnemonic="PUSH", .op={ {.f=F_ADDR_E | F_OPER_V}, 0, 0, 0}, },            /* desc=Push Word, Doubleword or Quadword Onto the Stack */
	{ .opcode1=0xFF, .reg_op=6, .m=MODOP_E, .mnemonic="PUSH", .op={ {.f=F_ADDR_E | F_OPER_VQ}, 0, 0, 0}, },            /* desc=Push Word, Doubleword or Quadword Onto the Stack */

	/**
	 * Two-Byte Instr
	**/

	{ .two_byte=0x0f, .opcode1=0x00, .reg_op='0', .m=MODOP_P, .ops=(x86_in_ops[]){ { .mnemonic="SLDT", .op={ {.f=F_ADDR_M | F_OPER_W}, {.reg="X86_LDTR"}, 0, 0 }, }, { .mnemonic="SLDT", .op={ {.f=F_ADDR_R | F_OPER_VQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Store Local Descriptor Table Register */
	{ .two_byte=0x0f, .opcode1=0x00, .reg_op=1, .m=MODOP_P, .ops=(x86_in_ops[]){ { .mnemonic="STR", .op={ {.f=F_ADDR_M | F_OPER_W}, {.reg="TR"}, 0, 0 }, }, { .mnemonic="STR", .op={ {.f=F_ADDR_R | F_OPER_VQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Store Task Register */
	...
	{ .two_byte=0x0f, .opcode1=0x01, .reg_op=4, .ops=(x86_in_ops[]){ { .mnemonic="SMSW", .op={ {.f=F_ADDR_M | F_OPER_W}, {.reg="MSW"}, 0, 0 }, }, { .mnemonic="SMSW", .op={ {.f=F_ADDR_R | F_OPER_VQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Store Machine Status Word */
	...
	{ .two_byte=0x0f, .opcode1=0x01, .opcode2=0xF8, .reg_op=7, .m=MODOP_E, .mnemonic="SWAPGS", .op={ {.reg="GS"}, {.f=F_ADDR_I}, 0, 0}, },            /* desc=Swap GS Base Register */
	...
	{ .two_byte=0x0f, .opcode1=0x02, .reg_op='r', .m=MODOP_P, .ops=(x86_in_ops[]){ { .mnemonic="LAR", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_M | F_OPER_W}, 0, 0 }, }, { .mnemonic="LAR", .op={ {.f=F_ADDR_G | F_OPER_VQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Load Access Rights Byte */
	{ .two_byte=0x0f, .opcode1=0x03, .reg_op='r', .m=MODOP_P, .ops=(x86_in_ops[]){ { .mnemonic="LSL", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_M | F_OPER_W}, 0, 0 }, }, { .mnemonic="LSL", .op={ {.f=F_ADDR_G | F_OPER_VQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Load Segment Limit */
	{ .two_byte=0x0f, .opcode1=0x05, .m=MODOP_E, .mnemonic="SYSCALL", .op={ {.reg="RCX"}, {.reg="R11"}, {.reg="SS"}, 0}, },            /* desc=Fast System Call */
	{ .two_byte=0x0f, .opcode1=0x06, .mnemonic="CLTS", .op={ {.reg="CR0"}, 0, 0, 0}, },            /* desc=Clear Task-Switched Flag in CR0 */
	{ .two_byte=0x0f, .opcode1=0x07, .m=MODOP_E, .mnemonic="SYSRET", .op={ {.reg="SS"}, {.f=F_ADDR_F | F_OPER_D}, {.reg="R11"}, 0}, .grp=GRP(SYSTEM, BRANCH, TRANS),  },            /* desc=Return From Fast System Call */
	...
	{ .two_byte=0x0f, .opcode1=0x20, .reg_op='r', .m=MODOP_E, .mnemonic="MOV", .op={ {.f=F_ADDR_R | F_OPER_Q}, {.f=F_ADDR_C | F_OPER_Q}, 0, 0}, },            /* desc=Move to/from Control Registers */
	{ .two_byte=0x0f, .opcode1=0x20, .reg_op='r', .m=MODOP_E, .mnemonic="MOV", .op={ {.f=F_ADDR_H | F_OPER_Q}, {.f=F_ADDR_C | F_OPER_Q}, 0, 0}, },            /* desc=Move to/from Control Registers */
	{ .two_byte=0x0f, .opcode1=0x21, .reg_op='r', .m=MODOP_E, .mnemonic="MOV", .op={ {.f=F_ADDR_R | F_OPER_Q}, {.f=F_ADDR_D | F_OPER_Q}, 0, 0}, },            /* desc=Move to/from Debug Registers */
	{ .two_byte=0x0f, .opcode1=0x21, .reg_op='r', .m=MODOP_E, .mnemonic="MOV", .op={ {.f=F_ADDR_H | F_OPER_Q}, {.f=F_ADDR_D | F_OPER_Q}, 0, 0}, },            /* desc=Move to/from Debug Registers */
	{ .two_byte=0x0f, .opcode1=0x22, .reg_op='r', .m=MODOP_E, .mnemonic="MOV", .op={ {.f=F_ADDR_C | F_OPER_Q}, {.f=F_ADDR_R | F_OPER_Q}, 0, 0}, },            /* desc=Move to/from Control Registers */
	{ .two_byte=0x0f, .opcode1=0x22, .reg_op='r', .m=MODOP_E, .mnemonic="MOV", .op={ {.f=F_ADDR_C | F_OPER_Q}, {.f=F_ADDR_H | F_OPER_Q}, 0, 0}, },            /* desc=Move to/from Control Registers */
	{ .two_byte=0x0f, .opcode1=0x23, .reg_op='r', .m=MODOP_E, .mnemonic="MOV", .op={ {.f=F_ADDR_D | F_OPER_Q}, {.f=F_ADDR_R | F_OPER_Q}, 0, 0}, },            /* desc=Move to/from Debug Registers */
	{ .two_byte=0x0f, .opcode1=0x23, .reg_op='r', .m=MODOP_E, .mnemonic="MOV", .op={ {.f=F_ADDR_D | F_OPER_Q}, {.f=F_ADDR_H | F_OPER_Q}, 0, 0}, },            /* desc=Move to/from Debug Registers */
	...
	{ .prefix=0xF3, .two_byte=0x0f, .opcode1=0x2A, .reg_op='r', .mnemonic="CVTSI2SS", .op={ {.f=F_ADDR_V | F_OPER_SS}, {.f=F_ADDR_E | F_OPER_DQP}, 0, 0}, },            /* desc=Convert DW Integer to Scalar Single-FP Value */
	...
	{ .prefix=0xF2, .two_byte=0x0f, .opcode1=0x2A, .reg_op='r', .mnemonic="CVTSI2SD", .op={ {.f=F_ADDR_V | F_OPER_SD}, {.f=F_ADDR_E | F_OPER_DQP}, 0, 0}, },            /* desc=Convert DW Integer to Scalar Double-FP Value */
	...
	{ .prefix=0xF3, .two_byte=0x0f, .opcode1=0x2C, .reg_op='r', .mnemonic="CVTTSS2SI", .op={ {.f=F_ADDR_G | F_OPER_DQP}, {.f=F_ADDR_W | F_OPER_SS}, 0, 0}, },            /* desc=Convert with Trunc. Scalar Single-FP Value to DW Integer */
	...
	{ .prefix=0xF2, .two_byte=0x0f, .opcode1=0x2C, .reg_op='r', .mnemonic="CVTTSD2SI", .op={ {.f=F_ADDR_G | F_OPER_DQP}, {.f=F_ADDR_W | F_OPER_SD}, 0, 0}, },            /* desc=Conv. with Trunc. Scalar Double-FP Value to Signed DW Int */
	...
	{ .prefix=0xF3, .two_byte=0x0f, .opcode1=0x2D, .reg_op='r', .mnemonic="CVTSS2SI", .op={ {.f=F_ADDR_G | F_OPER_DQP}, {.f=F_ADDR_W | F_OPER_SS}, 0, 0}, },            /* desc=Convert Scalar Single-FP Value to DW Integer */
	...
	{ .prefix=0xF2, .two_byte=0x0f, .opcode1=0x2D, .reg_op='r', .mnemonic="CVTSD2SI", .op={ {.f=F_ADDR_G | F_OPER_DQP}, {.f=F_ADDR_W | F_OPER_SD}, 0, 0}, },            /* desc=Convert Scalar Double-FP Value to DW Integer */
	...
	{ .two_byte=0x0f, .opcode1=0x30, .mnemonic="WRMSR", .op={ {.reg="MSR"}, {.reg="rCX"}, {.reg="rAX"}, {.reg="rDX"}}, },            /* desc=Write to Model Specific Register */
	{ .two_byte=0x0f, .opcode1=0x31, .mnemonic="RDTSC", .op={ {.reg="EAX"}, {.reg="EDX"}, {.f=F_ADDR_I}, 0}, },            /* desc=Read Time-Stamp Counter */
	{ .two_byte=0x0f, .opcode1=0x32, .mnemonic="RDMSR", .op={ {.reg="rAX"}, {.reg="rDX"}, {.reg="rCX"}, {.reg="MSR"}}, },            /* desc=Read from Model Specific Register */
	{ .two_byte=0x0f, .opcode1=0x33, .mnemonic="RDPMC", .op={ {.reg="EAX"}, {.reg="EDX"}, {.reg="PMC"}, 0}, },            /* desc=Read Performance-Monitoring Counters */
	{ .two_byte=0x0f, .opcode1=0x34, .m=MODOP_E, .mnemonic="SYSENTER", .op={ {.reg="SS"}, {.reg="RSP"}, {.f=F_ADDR_I}, 0}, },            /* desc=Fast System Call */
	...
	{ .prefix=0x66, .two_byte=0x0f, .opcode1=0x38, .opcode2=0x80, .reg_op='r', .m=MODOP_E, .mnemonic="INVEPT", .op={ {.f=F_ADDR_G | F_OPER_Q}, {.f=F_ADDR_M | F_OPER_DQ}, 0, 0}, },            /* desc=Invalidate Translations Derived from EPT */
	{ .prefix=0x66, .two_byte=0x0f, .opcode1=0x38, .opcode2=0x81, .reg_op='r', .m=MODOP_E, .mnemonic="INVVPID", .op={ {.f=F_ADDR_G | F_OPER_Q}, {.f=F_ADDR_M | F_OPER_DQ}, 0, 0}, },            /* desc=Invalidate Translations Based on VPID */
	{ .two_byte=0x0f, .opcode1=0x38, .opcode2=0xF0, .reg_op='r', .mnemonic="MOVBE", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_M | F_OPER_VQP}, 0, 0}, },            /* desc=Move Data After Swapping Bytes */
	{ .prefix=0xF2, .two_byte=0x0f, .opcode1=0x38, .opcode2=0xF0, .reg_op='r', .mnemonic="CRC32", .op={ {.f=F_ADDR_G | F_OPER_DQP}, {.f=F_ADDR_E | F_OPER_B}, 0, 0}, },            /* desc=Accumulate CRC32 Value */
	{ .two_byte=0x0f, .opcode1=0x38, .opcode2=0xF1, .reg_op='r', .mnemonic="MOVBE", .op={ {.f=F_ADDR_M | F_OPER_VQP}, {.f=F_ADDR_G | F_OPER_VQP}, 0, 0}, },            /* desc=Move Data After Swapping Bytes */
	{ .prefix=0xF2, .two_byte=0x0f, .opcode1=0x38, .opcode2=0xF1, .reg_op='r', .mnemonic="CRC32", .op={ {.f=F_ADDR_G | F_OPER_DQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0}, },            /* desc=Accumulate CRC32 Value */
	...
	{ .prefix=0x66, .two_byte=0x0f, .opcode1=0x3A, .opcode2=0x14, .reg_op='r', .ops=(x86_in_ops[]){ { .mnemonic="PEXTRB", .op={ {.f=F_ADDR_M | F_OPER_B}, {.f=F_ADDR_V | F_OPER_DQ}, {.f=F_ADDR_I | F_OPER_B}, 0 }, }, { .mnemonic="PEXTRB", .op={ {.f=F_ADDR_R | F_OPER_DQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Extract Byte */
	{ .prefix=0x66, .two_byte=0x0f, .opcode1=0x3A, .opcode2=0x15, .reg_op='r', .ops=(x86_in_ops[]){ { .mnemonic="PEXTRW", .op={ {.f=F_ADDR_M | F_OPER_W}, {.f=F_ADDR_V | F_OPER_DQ}, {.f=F_ADDR_I | F_OPER_B}, 0 }, }, { .mnemonic="PEXTRW", .op={ {.f=F_ADDR_R | F_OPER_DQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Extract Word */
	...
	{ .prefix=0x66, .two_byte=0x0f, .opcode1=0x3A, .opcode2=0x61, .reg_op='r', .mnemonic="PCMPESTRI", .op={ {.reg="rCX"}, {.f=F_ADDR_V | F_OPER_DQ}, {.f=F_ADDR_W | F_OPER_DQ}, 0}, },            /* desc=Packed Compare Explicit Length Strings, Return Index */
	...
	{ .prefix=0x66, .two_byte=0x0f, .opcode1=0x3A, .opcode2=0x63, .reg_op='r', .mnemonic="PCMPISTRI", .op={ {.reg="rCX"}, {.f=F_ADDR_V | F_OPER_DQ}, {.f=F_ADDR_W | F_OPER_DQ}, {.f=F_ADDR_I | F_OPER_B}}, },            /* desc=Packed Compare Implicit Length Strings, Return Index */
	{ .two_byte=0x0f, .opcode1=0x40, .reg_op='r', .mnemonic="CMOVO", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0}, },            /* desc=Conditional Move - overflow (OF=1) */
	{ .two_byte=0x0f, .opcode1=0x41, .reg_op='r', .mnemonic="CMOVNO", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0}, },            /* desc=Conditional Move - not overflow (OF=0) */
	{ .two_byte=0x0f, .opcode1=0x42, .reg_op='r', .ops=(x86_in_ops[]){ { .mnemonic="CMOVB", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0 }, }, { .mnemonic="CMOVNAE", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0 }, }, { .mnemonic="CMOVC", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0 }, },  }, .ops_count=3,  },            /* desc=Conditional Move - below/not above or equal/carry (CF=1) */
	{ .two_byte=0x0f, .opcode1=0x43, .reg_op='r', .ops=(x86_in_ops[]){ { .mnemonic="CMOVNB", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0 }, }, { .mnemonic="CMOVAE", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0 }, }, { .mnemonic="CMOVNC", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0 }, },  }, .ops_count=3,  },            /* desc=Conditional Move - not below/above or equal/not carry (CF=0) */
	{ .two_byte=0x0f, .opcode1=0x44, .reg_op='r', .ops=(x86_in_ops[]){ { .mnemonic="CMOVZ", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0 }, }, { .mnemonic="CMOVE", .op={ {.f=F_ADDR_G | F_OPER_VQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Conditional Move - zero/equal (ZF=1) */
	{ .two_byte=0x0f, .opcode1=0x45, .reg_op='r', .ops=(x86_in_ops[]){ { .mnemonic="CMOVNZ", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0 }, }, { .mnemonic="CMOVNE", .op={ {.f=F_ADDR_G | F_OPER_VQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Conditional Move - not zero/not equal (ZF=0) */
	{ .two_byte=0x0f, .opcode1=0x46, .reg_op='r', .ops=(x86_in_ops[]){ { .mnemonic="CMOVBE", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0 }, }, { .mnemonic="CMOVNA", .op={ {.f=F_ADDR_G | F_OPER_VQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Conditional Move - below or equal/not above (CF=1 OR ZF=1) */
	{ .two_byte=0x0f, .opcode1=0x47, .reg_op='r', .ops=(x86_in_ops[]){ { .mnemonic="CMOVNBE", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0 }, }, { .mnemonic="CMOVA", .op={ {.f=F_ADDR_G | F_OPER_VQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Conditional Move - not below or equal/above (CF=0 AND ZF=0) */
	{ .two_byte=0x0f, .opcode1=0x48, .reg_op='r', .mnemonic="CMOVS", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0}, },            /* desc=Conditional Move - sign (SF=1) */
	{ .two_byte=0x0f, .opcode1=0x49, .reg_op='r', .mnemonic="CMOVNS", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0}, },            /* desc=Conditional Move - not sign (SF=0) */
	{ .two_byte=0x0f, .opcode1=0x4A, .reg_op='r', .ops=(x86_in_ops[]){ { .mnemonic="CMOVP", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0 }, }, { .mnemonic="CMOVPE", .op={ {.f=F_ADDR_G | F_OPER_VQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Conditional Move - parity/parity even (PF=1) */
	{ .two_byte=0x0f, .opcode1=0x4B, .reg_op='r', .ops=(x86_in_ops[]){ { .mnemonic="CMOVNP", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0 }, }, { .mnemonic="CMOVPO", .op={ {.f=F_ADDR_G | F_OPER_VQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Conditional Move - not parity/parity odd (PF=0) */
	{ .two_byte=0x0f, .opcode1=0x4C, .reg_op='r', .ops=(x86_in_ops[]){ { .mnemonic="CMOVL", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0 }, }, { .mnemonic="CMOVNGE", .op={ {.f=F_ADDR_G | F_OPER_VQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Conditional Move - less/not greater (SF!=OF) */
	{ .two_byte=0x0f, .opcode1=0x4D, .reg_op='r', .ops=(x86_in_ops[]){ { .mnemonic="CMOVNL", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0 }, }, { .mnemonic="CMOVGE", .op={ {.f=F_ADDR_G | F_OPER_VQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Conditional Move - not less/greater or equal (SF=OF) */
	{ .two_byte=0x0f, .opcode1=0x4E, .reg_op='r', .ops=(x86_in_ops[]){ { .mnemonic="CMOVLE", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0 }, }, { .mnemonic="CMOVNG", .op={ {.f=F_ADDR_G | F_OPER_VQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Conditional Move - less or equal/not greater ((ZF=1) OR (SF!=OF)) */
	{ .two_byte=0x0f, .opcode1=0x4F, .reg_op='r', .ops=(x86_in_ops[]){ { .mnemonic="CMOVNLE", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0 }, }, { .mnemonic="CMOVG", .op={ {.f=F_ADDR_G | F_OPER_VQP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Conditional Move - not less nor equal/greater ((ZF=0) AND (SF=OF)) */
	{ .two_byte=0x0f, .opcode1=0x50, .reg_op='r', .mnemonic="MOVMSKPS", .op={ {.f=F_ADDR_G | F_OPER_DQP}, {.f=F_ADDR_U | F_OPER_PS}, 0, 0}, },            /* desc=Extract Packed Single-FP Sign Mask */
	{ .prefix=0x66, .two_byte=0x0f, .opcode1=0x50, .reg_op='r', .mnemonic="MOVMSKPD", .op={ {.f=F_ADDR_G | F_OPER_DQP}, {.f=F_ADDR_U | F_OPER_PD}, 0, 0}, },            /* desc=Extract Packed Double-FP Sign Mask */
	...
	{ .two_byte=0x0f, .opcode1=0x6E, .reg_op='r', .m=MODOP_E, .ops=(x86_in_ops[]){ { .mnemonic="MOVD", .op={ {.f=F_ADDR_P | F_OPER_Q}, {.f=F_ADDR_E | F_OPER_D}, 0, 0 }, }, { .mnemonic="MOVQ", .op={ {.f=F_ADDR_P | F_OPER_Q}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Move Doubleword/Quadword */
	{ .prefix=0x66, .two_byte=0x0f, .opcode1=0x6E, .reg_op='r', .m=MODOP_E, .ops=(x86_in_ops[]){ { .mnemonic="MOVD", .op={ {.f=F_ADDR_V | F_OPER_DQ}, {.f=F_ADDR_E | F_OPER_D}, 0, 0 }, }, { .mnemonic="MOVQ", .op={ {.f=F_ADDR_V | F_OPER_DQ}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Move Doubleword/Quadword */
	...
	{ .two_byte=0x0f, .opcode1=0x78, .reg_op='r', .m=MODOP_E, .mnemonic="VMREAD", .op={ {.f=F_ADDR_E | F_OPER_Q}, {.f=F_ADDR_G | F_OPER_Q}, 0, 0}, },            /* desc=Read Field from Virtual-Machine Control Structure */
	{ .two_byte=0x0f, .opcode1=0x79, .reg_op='r', .m=MODOP_E, .mnemonic="VMWRITE", .op={ {.f=F_ADDR_G | F_OPER_Q}, {.f=F_ADDR_E | F_OPER_Q}, 0, 0}, },            /* desc=Write Field to Virtual-Machine Control Structure */
	...
	{ .two_byte=0x0f, .opcode1=0x7E, .reg_op='r', .m=MODOP_E, .ops=(x86_in_ops[]){ { .mnemonic="MOVD", .op={ {.f=F_ADDR_E | F_OPER_D}, {.f=F_ADDR_P | F_OPER_Q}, 0, 0 }, }, { .mnemonic="MOVQ", .op={ {.f=F_ADDR_E | F_OPER_QP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Move Doubleword/Quadword */
	{ .prefix=0x66, .two_byte=0x0f, .opcode1=0x7E, .reg_op='r', .m=MODOP_E, .ops=(x86_in_ops[]){ { .mnemonic="MOVD", .op={ {.f=F_ADDR_E | F_OPER_D}, {.f=F_ADDR_V | F_OPER_DQ}, 0, 0 }, }, { .mnemonic="MOVQ", .op={ {.f=F_ADDR_E | F_OPER_QP}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Move Doubleword/Quadword */
	...
	{ .two_byte=0x0f, .opcode1=0x80, .mnemonic="JO", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0}, .grp=GRP(GEN, BRANCH, COND),  },            /* desc=Jump near if overflow (OF=1) */
	{ .two_byte=0x0f, .opcode1=0x81, .mnemonic="JNO", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0}, .grp=GRP(GEN, BRANCH, COND),  },            /* desc=Jump near if not overflow (OF=0) */
	{ .two_byte=0x0f, .opcode1=0x82, .ops=(x86_in_ops[]){ { .mnemonic="JB", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), }, { .mnemonic="JNAE", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), }, { .mnemonic="JC", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), },  }, .ops_count=3,  },            /* desc=Jump near if below/not above or equal/carry (CF=1) */
	{ .two_byte=0x0f, .opcode1=0x83, .ops=(x86_in_ops[]){ { .mnemonic="JNB", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), }, { .mnemonic="JAE", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), }, { .mnemonic="JNC", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), },  }, .ops_count=3,  },            /* desc=Jump near if not below/above or equal/not carry (CF=0) */
	{ .two_byte=0x0f, .opcode1=0x84, .ops=(x86_in_ops[]){ { .mnemonic="JZ", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), }, { .mnemonic="JE", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), },  }, .ops_count=2,  },            /* desc=Jump near if zero/equal (ZF=1) */
	{ .two_byte=0x0f, .opcode1=0x85, .ops=(x86_in_ops[]){ { .mnemonic="JNZ", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), }, { .mnemonic="JNE", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), },  }, .ops_count=2,  },            /* desc=Jump near if not zero/not equal (ZF=0) */
	{ .two_byte=0x0f, .opcode1=0x86, .ops=(x86_in_ops[]){ { .mnemonic="JBE", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), }, { .mnemonic="JNA", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), },  }, .ops_count=2,  },            /* desc=Jump near if below or equal/not above (CF=1 OR ZF=1) */
	{ .two_byte=0x0f, .opcode1=0x87, .ops=(x86_in_ops[]){ { .mnemonic="JNBE", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), }, { .mnemonic="JA", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), },  }, .ops_count=2,  },            /* desc=Jump near if not below or equal/above (CF=0 AND ZF=0) */
	{ .two_byte=0x0f, .opcode1=0x88, .mnemonic="JS", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0}, .grp=GRP(GEN, BRANCH, COND),  },            /* desc=Jump near if sign (SF=1) */
	{ .two_byte=0x0f, .opcode1=0x89, .mnemonic="JNS", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0}, .grp=GRP(GEN, BRANCH, COND),  },            /* desc=Jump near if not sign (SF=0) */
	{ .two_byte=0x0f, .opcode1=0x8A, .ops=(x86_in_ops[]){ { .mnemonic="JP", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), }, { .mnemonic="JPE", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), },  }, .ops_count=2,  },            /* desc=Jump near if parity/parity even (PF=1) */
	{ .two_byte=0x0f, .opcode1=0x8B, .ops=(x86_in_ops[]){ { .mnemonic="JNP", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), }, { .mnemonic="JPO", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), },  }, .ops_count=2,  },            /* desc=Jump near if not parity/parity odd (PF=0) */
	{ .two_byte=0x0f, .opcode1=0x8C, .ops=(x86_in_ops[]){ { .mnemonic="JL", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), }, { .mnemonic="JNGE", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), },  }, .ops_count=2,  },            /* desc=Jump near if less/not greater (SF!=OF) */
	{ .two_byte=0x0f, .opcode1=0x8D, .ops=(x86_in_ops[]){ { .mnemonic="JNL", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), }, { .mnemonic="JGE", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), },  }, .ops_count=2,  },            /* desc=Jump near if not less/greater or equal (SF=OF) */
	{ .two_byte=0x0f, .opcode1=0x8E, .ops=(x86_in_ops[]){ { .mnemonic="JLE", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), }, { .mnemonic="JNG", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), },  }, .ops_count=2,  },            /* desc=Jump near if less or equal/not greater ((ZF=1) OR (SF!=OF)) */
	{ .two_byte=0x0f, .opcode1=0x8F, .ops=(x86_in_ops[]){ { .mnemonic="JNLE", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), }, { .mnemonic="JG", .op={ {.f=F_ADDR_J | F_OPER_VDS}, 0, 0, 0 },  .grp=GRP(GEN, BRANCH, COND), },  }, .ops_count=2,  },            /* desc=Jump near if not less nor equal/greater ((ZF=0) AND (SF=OF)) */
	...
	{ .two_byte=0x0f, .opcode1=0xA3, .reg_op='r', .mnemonic="BT", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_G | F_OPER_VQP}, 0, 0}, },            /* desc=Bit Test */
	{ .two_byte=0x0f, .opcode1=0xA4, .reg_op='r', .mnemonic="SHLD", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_B}, 0}, },            /* desc=Double Precision Shift Left */
	{ .two_byte=0x0f, .opcode1=0xA5, .reg_op='r', .mnemonic="SHLD", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_G | F_OPER_VQP}, {.reg="CL"}, 0}, },            /* desc=Double Precision Shift Left */
	...
	{ .two_byte=0x0f, .opcode1=0xAB, .reg_op='r', .mnemonic="BTS", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_G | F_OPER_VQP}, 0, 0}, },            /* desc=Bit Test and Set */
	{ .two_byte=0x0f, .opcode1=0xAC, .reg_op='r', .mnemonic="SHRD", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_B}, 0}, },            /* desc=Double Precision Shift Right */
	{ .two_byte=0x0f, .opcode1=0xAD, .reg_op='r', .mnemonic="SHRD", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_G | F_OPER_VQP}, {.reg="CL"}, 0}, },            /* desc=Double Precision Shift Right */
	...
	{ .two_byte=0x0f, .opcode1=0xAE, .reg_op='0', .m=MODOP_E, .mnemonic="FXSAVE", .op={ {.f=F_ADDR_M | F_OPER_STX}, {.reg="ST"}, {.reg="ST1"}, 0}, },            /* desc=Save x87 FPU, MMX, XMM, and MXCSR State */
	...
	{ .two_byte=0x0f, .opcode1=0xAE, .reg_op=1, .m=MODOP_E, .mnemonic="FXRSTOR", .op={ {.reg="ST"}, {.reg="ST1"}, {.reg="ST2"}, 0}, },            /* desc=Restore x87 FPU, MMX, XMM, and MXCSR State */
	...
	{ .two_byte=0x0f, .opcode1=0xAE, .reg_op=4, .m=MODOP_E, .mnemonic="XSAVE", .op={ {.f=F_ADDR_M}, {.reg="EDX"}, {.reg="EAX"}, 0}, },            /* desc=Save Processor Extended States */
	{ .two_byte=0x0f, .opcode1=0xAE, .reg_op=5, .mnemonic="LFENCE", .op={ 0, 0, 0, 0}, },            /* desc=Load Fence */
	{ .two_byte=0x0f, .opcode1=0xAE, .reg_op=5, .m=MODOP_E, .mnemonic="XRSTOR", .op={ {.reg="ST"}, {.reg="ST1"}, {.reg="ST2"}, 0}, },            /* desc=Restore Processor Extended States */
	...
	{ .two_byte=0x0f, .opcode1=0xAF, .reg_op='r', .mnemonic="IMUL", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0}, .grp=GRP(GEN, ARITH, BINARY),  },            /* desc=Signed Multiply */
	...
	{ .two_byte=0x0f, .opcode1=0xB1, .reg_op='r', .mnemonic="CMPXCHG", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.reg="rAX"}, {.f=F_ADDR_G | F_OPER_VQP}, 0}, .grp=GRP(GEN, DATAMOV_ARITH, BINARY),  },            /* desc=Compare and Exchange */
	{ .two_byte=0x0f, .opcode1=0xB2, .reg_op='r', .mnemonic="LSS", .op={ {.reg="SS"}, {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_M | F_OPER_PTP}, 0}, },            /* desc=Load Far Pointer */
	{ .two_byte=0x0f, .opcode1=0xB3, .reg_op='r', .mnemonic="BTR", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_G | F_OPER_VQP}, 0, 0}, },            /* desc=Bit Test and Reset */
	{ .two_byte=0x0f, .opcode1=0xB4, .reg_op='r', .mnemonic="LFS", .op={ {.reg="FS"}, {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_M | F_OPER_PTP}, 0}, },            /* desc=Load Far Pointer */
	{ .two_byte=0x0f, .opcode1=0xB5, .reg_op='r', .mnemonic="LGS", .op={ {.reg="GS"}, {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_M | F_OPER_PTP}, 0}, },            /* desc=Load Far Pointer */
	{ .two_byte=0x0f, .opcode1=0xB6, .reg_op='r', .mnemonic="MOVZX", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_B}, 0, 0}, },            /* desc=Move with Zero-Extend */
	{ .two_byte=0x0f, .opcode1=0xB7, .reg_op='r', .mnemonic="MOVZX", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_W}, 0, 0}, },            /* desc=Move with Zero-Extend */
	{ .two_byte=0x0f, .opcode1=0xB8, .mnemonic="JMPE", .op={ 0, 0, 0, 0}, },            /* desc=Jump to IA-64 Instruction Set */
	{ .prefix=0xF3, .two_byte=0x0f, .opcode1=0xB8, .reg_op='r', .mnemonic="POPCNT", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0}, },            /* desc=Bit Population Count */
	{ .two_byte=0x0f, .opcode1=0xB9, .reg_op='r', .mnemonic="UD", .op={ {.f=F_ADDR_G}, {.f=F_ADDR_E}, 0, 0}, },            /* desc=Undefined Instruction */
	{ .two_byte=0x0f, .opcode1=0xBA, .reg_op=4, .mnemonic="BT", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_B}, 0, 0}, },            /* desc=Bit Test */
	{ .two_byte=0x0f, .opcode1=0xBA, .reg_op=5, .mnemonic="BTS", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_B}, 0, 0}, },            /* desc=Bit Test and Set */
	{ .two_byte=0x0f, .opcode1=0xBA, .reg_op=6, .mnemonic="BTR", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_B}, 0, 0}, },            /* desc=Bit Test and Reset */
	{ .two_byte=0x0f, .opcode1=0xBA, .reg_op=7, .mnemonic="BTC", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_I | F_OPER_B}, 0, 0}, },            /* desc=Bit Test and Complement */
	{ .two_byte=0x0f, .opcode1=0xBB, .reg_op='r', .mnemonic="BTC", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_G | F_OPER_VQP}, 0, 0}, },            /* desc=Bit Test and Complement */
	{ .two_byte=0x0f, .opcode1=0xBC, .reg_op='r', .mnemonic="BSF", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0}, },            /* desc=Bit Scan Forward */
	{ .two_byte=0x0f, .opcode1=0xBD, .reg_op='r', .mnemonic="BSR", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_VQP}, 0, 0}, },            /* desc=Bit Scan Reverse */
	{ .two_byte=0x0f, .opcode1=0xBE, .reg_op='r', .mnemonic="MOVSX", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_B}, 0, 0}, },            /* desc=Move with Sign-Extension */
	{ .two_byte=0x0f, .opcode1=0xBF, .reg_op='r', .mnemonic="MOVSX", .op={ {.f=F_ADDR_G | F_OPER_VQP}, {.f=F_ADDR_E | F_OPER_W}, 0, 0}, },            /* desc=Move with Sign-Extension */
	...
	{ .two_byte=0x0f, .opcode1=0xC1, .reg_op='r', .mnemonic="XADD", .op={ {.f=F_ADDR_E | F_OPER_VQP}, {.f=F_ADDR_G | F_OPER_VQP}, 0, 0}, .grp=GRP(GEN, DATAMOV_ARITH, BINARY),  },            /* desc=Exchange and Add */
	...
	{ .two_byte=0x0f, .opcode1=0xC3, .reg_op='r', .mnemonic="MOVNTI", .op={ {.f=F_ADDR_M | F_OPER_DQP}, {.f=F_ADDR_G | F_OPER_DQP}, 0, 0}, },            /* desc=Store Doubleword Using Non-Temporal Hint */
	{ .two_byte=0x0f, .opcode1=0xC4, .reg_op='r', .ops=(x86_in_ops[]){ { .mnemonic="PINSRW", .op={ {.f=F_ADDR_P | F_OPER_Q}, {.f=F_ADDR_R | F_OPER_DQP}, {.f=F_ADDR_I | F_OPER_B}, 0 }, }, { .mnemonic="PINSRW", .op={ {.f=F_ADDR_P | F_OPER_Q}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Insert Word */
	{ .prefix=0x66, .two_byte=0x0f, .opcode1=0xC4, .reg_op='r', .ops=(x86_in_ops[]){ { .mnemonic="PINSRW", .op={ {.f=F_ADDR_V | F_OPER_DQ}, {.f=F_ADDR_R | F_OPER_DQP}, {.f=F_ADDR_I | F_OPER_B}, 0 }, }, { .mnemonic="PINSRW", .op={ {.f=F_ADDR_V | F_OPER_DQ}, 0, 0, 0 }, },  }, .ops_count=2,  },            /* desc=Insert Word */
	{ .two_byte=0x0f, .opcode1=0xC5, .reg_op='r', .mnemonic="PEXTRW", .op={ {.f=F_ADDR_G | F_OPER_DQP}, {.f=F_ADDR_N | F_OPER_Q}, {.f=F_ADDR_I | F_OPER_B}, 0}, },            /* desc=Extract Word */
	{ .prefix=0x66, .two_byte=0x0f, .opcode1=0xC5, .reg_op='r', .mnemonic="PEXTRW", .op={ {.f=F_ADDR_G | F_OPER_DQP}, {.f=F_ADDR_U | F_OPER_DQ}, {.f=F_ADDR_I | F_OPER_B}, 0}, },            /* desc=Extract Word */
	...
	{ .two_byte=0x0f, .opcode1=0xC7, .reg_op=1, .m=MODOP_E, .ops=(x86_in_ops[]){ { .mnemonic="CMPXCHG8B", .op={ {.f=F_ADDR_M | F_OPER_Q}, {.reg="EAX"}, {.reg="EDX"}, 0 },  .grp=GRP(GEN, DATAMOV_ARITH, BINARY), }, { .mnemonic="CMPXCHG16B", .op={ {.f=F_ADDR_M | F_OPER_DQ}, 0, 0, 0 },  .grp=GRP(GEN, DATAMOV_ARITH, BINARY), },  }, .ops_count=2,  },            /* desc=Compare and Exchange Bytes */
	...
	{ .two_byte=0x0f, .opcode1=0xC8, .flds=1, .mnemonic="BSWAP", .op={ {.f=F_ADDR_Z | F_OPER_VQP}, 0, 0, 0}, },            /* desc=Byte Swap */
	...
	{ .two_byte=0x0f, .opcode1=0xD7, .reg_op='r', .mnemonic="PMOVMSKB", .op={ {.f=F_ADDR_G | F_OPER_DQP}, {.f=F_ADDR_N | F_OPER_Q}, 0, 0}, },            /* desc=Move Byte Mask */
	{ .prefix=0x66, .two_byte=0x0f, .opcode1=0xD7, .reg_op='r', .mnemonic="PMOVMSKB", .op={ {.f=F_ADDR_G | F_OPER_DQP}, {.f=F_ADDR_U | F_OPER_DQ}, 0, 0}, },            /* desc=Move Byte Mask */
