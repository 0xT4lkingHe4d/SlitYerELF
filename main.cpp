...
int main(int argc, char *argv[]) {
    ...
    r->_rel_(rx->ll, RelT::BufInsert, (void*)sc, s_elf->ehdr->e_entry, sizeof(sc)-1);
    ...
    auto mm = (mmsz_t*)(new mmsz_tup(sizeof(Elf_Shdr)*2));
    memcpy(mm->mem, &s_elf->shdr[29], sizeof(Elf_Shdr)*2);
    p.ins_hdr(ElfHdrT::Shdr, s_elf->ehdr->e_shoff + sizeof(Elf_Shdr)*10, mm);
