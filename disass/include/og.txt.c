...
const instr tabl[941] = (const instr[941]){
	...
	{ .opcode1=0x06, /* mnemo - invalid */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Invalid Instruction in 64-Bit Mode */ },
	{ .opcode1=0x07, /* mnemo - invalid */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Invalid Instruction in 64-Bit Mode */ },
	...
	{ .opcode1=0x0E, /* mnemo - invalid */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Invalid Instruction in 64-Bit Mode */ },
	...
	{ .opcode1=0x16, /* mnemo - invalid */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Invalid Instruction in 64-Bit Mode */ },
	{ .opcode1=0x17, /* mnemo - invalid */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Invalid Instruction in 64-Bit Mode */ },
	...
	{ .opcode1=0x1E, /* mnemo - invalid */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Invalid Instruction in 64-Bit Mode */ },
	{ .opcode1=0x1F, /* mnemo - invalid */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Invalid Instruction in 64-Bit Mode */ },
	...
	{ .prefix=0x26, /* mnemo - null */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Null Prefix in 64-bit Mode */ },
	{ .opcode1=0x27, /* mnemo - invalid */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Invalid Instruction in 64-Bit Mode */ },
	...
	{ .prefix=0x2E, /* mnemo - null */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Null Prefix in 64-bit Mode */ },
	{ .opcode1=0x2F, /* mnemo - invalid */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Invalid Instruction in 64-Bit Mode */ },
	...
	{ .prefix=0x36, /* mnemo - null */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Null Prefix in 64-bit Mode */ },
	{ .opcode1=0x37, /* mnemo - invalid */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Invalid Instruction in 64-Bit Mode */ },
	...
	{ .prefix=0x3E, /* mnemo - null */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Null Prefix in 64-bit Mode */ },
	{ .opcode1=0x3F, /* mnemo - invalid */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Invalid Instruction in 64-Bit Mode */ },
	{ .prefix=0x40, .mnemonic="REX", .op={ 0, 0, 0, 0, }, /* DESCRIPTION=Access to new 8-bit registers */ },
	{ .prefix=0x41, .mnemonic="REX.B", .op={ 0, 0, 0, 0, }, /* DESCRIPTION=Extension of r/m field, base field, or opcode reg field */ },
	{ .prefix=0x42, .mnemonic="REX.X", .op={ 0, 0, 0, 0, }, /* DESCRIPTION=Extension of SIB index field */ },
	{ .prefix=0x43, .mnemonic="REX.XB", .op={ 0, 0, 0, 0, }, /* DESCRIPTION=REX.X and REX.B combination */ },
	{ .prefix=0x44, .mnemonic="REX.R", .op={ 0, 0, 0, 0, }, /* DESCRIPTION=Extension of ModR/M reg field */ },
	{ .prefix=0x45, .mnemonic="REX.RB", .op={ 0, 0, 0, 0, }, /* DESCRIPTION=REX.R and REX.B combination */ },
	{ .prefix=0x46, .mnemonic="REX.RX", .op={ 0, 0, 0, 0, }, /* DESCRIPTION=REX.R and REX.X combination */ },
	{ .prefix=0x47, .mnemonic="REX.RXB", .op={ 0, 0, 0, 0, }, /* DESCRIPTION=REX.R, REX.X and REX.B combination */ },
	{ .prefix=0x48, .mnemonic="REX.W", .op={ 0, 0, 0, 0, }, /* DESCRIPTION=64 Bit Operand Size */ },
	{ .prefix=0x49, .mnemonic="REX.WB", .op={ 0, 0, 0, 0, }, /* DESCRIPTION=REX.W and REX.B combination */ },
	{ .prefix=0x4A, .mnemonic="REX.WX", .op={ 0, 0, 0, 0, }, /* DESCRIPTION=REX.W and REX.X combination */ },
	{ .prefix=0x4B, .mnemonic="REX.WXB", .op={ 0, 0, 0, 0, }, /* DESCRIPTION=REX.W, REX.X and REX.B combination */ },
	{ .prefix=0x4C, .mnemonic="REX.WR", .op={ 0, 0, 0, 0, }, /* DESCRIPTION=REX.W and REX.R combination */ },
	{ .prefix=0x4D, .mnemonic="REX.WRB", .op={ 0, 0, 0, 0, }, /* DESCRIPTION=REX.W, REX.R and REX.B combination */ },
	{ .prefix=0x4E, .mnemonic="REX.WRX", .op={ 0, 0, 0, 0, }, /* DESCRIPTION=REX.W, REX.R and REX.X combination */ },
	{ .prefix=0x4F, .mnemonic="REX.WRXB", .op={ 0, 0, 0, 0, }, /* DESCRIPTION=REX.W, REX.R, REX.X and REX.B combination */ },
	{ .opcode1=0x50, .flds="+r", .mnemonic="PUSH", .op={ {.f=F_ADDR_Z | F_OPERAND_VQ, }, 0, 0, 0, }, /* DESCRIPTION=Push Word, Doubleword or Quadword Onto the Stack */ },
	{ .opcode1=0x58, .flds="+r", .mnemonic="POP", .op={ {.f=F_ADDR_Z | F_OPERAND_VQ, }, 0, 0, 0, }, /* DESCRIPTION=Pop a Value from the Stack */ },
	{ .opcode1=0x60, /* mnemo - invalid */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Invalid Instruction in 64-Bit Mode */ },
	{ .opcode1=0x61, /* mnemo - invalid */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Invalid Instruction in 64-Bit Mode */ },
	{ .opcode1=0x62, /* mnemo - invalid */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Invalid Instruction in 64-Bit Mode */ },
	{ .opcode1=0x63, .reg_op=F_MODRM, .mnemonic="MOVSXD", .op={ {.f=F_ADDR_G | F_OPERAND_DQP, }, {.f=F_ADDR_E | F_OPERAND_D, }, 0, 0, }, /* DESCRIPTION=Move with Sign-Extension */ },
	...
	{ .opcode1=0x82, /* mnemo - invalid */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Invalid Instruction in 64-Bit Mode */ },
	...
	{ .opcode1=0x8F, .reg_op=0xb0, .mnemonic="POP", .op={ {.f=F_ADDR_E | F_OPERAND_VQ, }, 0, 0, 0, }, /* DESCRIPTION=Pop a Value from the Stack */ },
	...
	{ .opcode1=0x98, .ops=(struct instr_ops[3]){ { .mnemonic="CBW", .op={ {.reg="AX", }, {.reg="AL", }, 0, 0, },  }, { .mnemonic="CWDE", .op={ {.reg="EAX", }, {.reg="AX", }, 0, 0, },  }, { .mnemonic="CDQE", .op={ {.reg="RAX", }, {.reg="EAX", }, 0, 0, },  } }, .ops_count=3, /* DESCRIPTION=Convert */ },
	{ .opcode1=0x99, .ops=(struct instr_ops[3]){ { .mnemonic="CWD", .op={ {.reg="DX", }, {.reg="AX", }, 0, 0, },  }, { .mnemonic="CDQ", .op={ {.reg="EDX", }, {.reg="EAX", }, 0, 0, },  }, { .mnemonic="CQO", .op={ {.reg="RDX", }, {.reg="RAX", }, 0, 0, },  } }, .ops_count=3, /* DESCRIPTION=Convert */ },
	{ .opcode1=0x9A, /* mnemo - invalid */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Invalid Instruction in 64-Bit Mode */ },
	...
	{ .opcode1=0x9C, .ops=(struct instr_ops[2]){ { .mnemonic="PUSHF", .op={ {.f=F_ADDR_F | F_OPERAND_WS, }, 0, 0, 0, },  }, { .mnemonic="PUSHFQ", .op={ {.f=F_ADDR_F | F_OPERAND_QS, }, 0, 0, 0, },  } }, .ops_count=2, /* DESCRIPTION=Push rFLAGS Register onto the Stack */ },
	{ .opcode1=0x9D, .ops=(struct instr_ops[2]){ { .mnemonic="POPF", .op={ {.f=F_ADDR_F | F_OPERAND_WS, }, 0, 0, 0, },  }, { .mnemonic="POPFQ", .op={ {.f=F_ADDR_F | F_OPERAND_QS, }, 0, 0, 0, },  } }, .ops_count=2, /* DESCRIPTION=Pop Stack into rFLAGS Register */ },
	...
	{ .opcode1=0xAB, .ops=(struct instr_ops[4]){ { .mnemonic="STOS", .op={ {.f=F_ADDR_Y | F_OPERAND_VQP, }, {.reg="rAX", }, 0, 0, },  }, { .mnemonic="STOSW", .op={ {.f=F_ADDR_Y | F_OPERAND_WO, }, {.reg="AX", }, 0, 0, },  }, { .mnemonic="STOSD", .op={ {.f=F_ADDR_Y | F_OPERAND_DO, }, {.reg="EAX", }, 0, 0, },  }, { .mnemonic="STOSQ", .op={ {.f=F_ADDR_Y | F_OPERAND_QP, }, {.reg="RAX", }, 0, 0, },  } }, .ops_count=4, /* DESCRIPTION=Store String */ },
	...
	{ .opcode1=0xAD, .ops=(struct instr_ops[4]){ { .mnemonic="LODS", .op={ {.reg="rAX", }, {.f=F_ADDR_X | F_OPERAND_VQP, }, 0, 0, },  }, { .mnemonic="LODSW", .op={ {.reg="AX", }, {.f=F_ADDR_X | F_OPERAND_WO, }, 0, 0, },  }, { .mnemonic="LODSD", .op={ {.reg="EAX", }, {.f=F_ADDR_X | F_OPERAND_DO, }, 0, 0, },  }, { .mnemonic="LODSQ", .op={ {.reg="RAX", }, {.f=F_ADDR_X | F_OPERAND_QP, }, 0, 0, },  } }, .ops_count=4, /* DESCRIPTION=Load String */ },
	...
	{ .opcode1=0xAF, .ops=(struct instr_ops[4]){ { .mnemonic="SCAS", .op={ {.f=F_ADDR_Y | F_OPERAND_VQP, }, {.reg="rAX", }, 0, 0, },  }, { .mnemonic="SCASW", .op={ {.f=F_ADDR_Y | F_OPERAND_WO, }, {.reg="AX", }, 0, 0, },  }, { .mnemonic="SCASD", .op={ {.f=F_ADDR_Y | F_OPERAND_DO, }, {.reg="EAX", }, 0, 0, },  }, { .mnemonic="SCASQ", .op={ {.f=F_ADDR_Y | F_OPERAND_QP, }, {.reg="RAX", }, 0, 0, },  } }, .ops_count=4, /* DESCRIPTION=Scan String */ },
	...
	{ .opcode1=0xC4, /* mnemo - invalid */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Invalid Instruction in 64-Bit Mode */ },
	{ .opcode1=0xC5, /* mnemo - invalid */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Invalid Instruction in 64-Bit Mode */ },
	...
	{ .opcode1=0xC8, .mnemonic="ENTER", .op={ {.reg="rBP", }, {.f=F_ADDR_I | F_OPERAND_W, }, {.f=F_ADDR_I | F_OPERAND_B, }, 0, }, /* DESCRIPTION=Make Stack Frame for Procedure Parameters */ },
	{ .opcode1=0xC9, .mnemonic="LEAVE", .op={ {.reg="rBP", }, 0, 0, 0, }, /* DESCRIPTION=High Level Procedure Exit */ },
	...
	{ .opcode1=0xCF, .ops=(struct instr_ops[3]){ { .mnemonic="IRET", .op={ {.f=F_ADDR_F | F_OPERAND_WO, }, 0, 0, 0, },  }, { .mnemonic="IRETD", .op={ {.f=F_ADDR_F | F_OPERAND_DO, }, 0, 0, 0, },  }, { .mnemonic="IRETQ", .op={ {.f=F_ADDR_F | F_OPERAND_QP, }, 0, 0, 0, },  } }, .ops_count=3, /* DESCRIPTION=Interrupt Return */ },
	...
	{ .opcode1=0xD4, /* mnemo - invalid */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Invalid Instruction in 64-Bit Mode */ },
	{ .opcode1=0xD5, /* mnemo - invalid */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Invalid Instruction in 64-Bit Mode */ },
	{ .opcode1=0xD6, /* mnemo - invalid */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Invalid Instruction in 64-Bit Mode */ },
	...
	{ .opcode1=0xE0, .ops=(struct instr_ops[2]){ { .mnemonic="LOOPNZ", .op={ {.reg="rCX", }, {.f=F_ADDR_J | F_OPERAND_BS, }, 0, 0, },  }, { .mnemonic="LOOPNE", .op={ {.reg="rCX", }, {.f=F_ADDR_J | F_OPERAND_BS, }, 0, 0, },  } }, .ops_count=2, /* DESCRIPTION=Decrement count; Jump short if count!=0 and ZF=0 */ },
	{ .opcode1=0xE1, .ops=(struct instr_ops[2]){ { .mnemonic="LOOPZ", .op={ {.reg="rCX", }, {.f=F_ADDR_J | F_OPERAND_BS, }, 0, 0, },  }, { .mnemonic="LOOPE", .op={ {.reg="rCX", }, {.f=F_ADDR_J | F_OPERAND_BS, }, 0, 0, },  } }, .ops_count=2, /* DESCRIPTION=Decrement count; Jump short if count!=0 and ZF=1 */ },
	{ .opcode1=0xE2, .mnemonic="LOOP", .op={ {.reg="rCX", }, {.f=F_ADDR_J | F_OPERAND_BS, }, 0, 0, }, /* DESCRIPTION=Decrement count; Jump short if count!=0 */ },
	{ .opcode1=0xE3, .ops=(struct instr_ops[2]){ { .mnemonic="JECXZ", .op={ {.f=F_ADDR_J | F_OPERAND_BS, }, {.reg="ECX", }, 0, 0, },  }, { .mnemonic="JRCXZ", .op={ {.f=F_ADDR_J | F_OPERAND_BS, }, {.reg="RCX", }, 0, 0, },  } }, .ops_count=2, /* DESCRIPTION=Jump short if rCX register is 0 */ },
	...
	{ .opcode1=0xEA, /* mnemo - invalid */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Invalid Instruction in 64-Bit Mode */ },
	...
	{ .prefix=0xF2, .ops=(struct instr_ops[2]){ { .mnemonic="REPNZ", .op={ {.reg="rCX", }, 0, 0, 0, },  }, { .mnemonic="REPNE", .op={ {.reg="rCX", }, 0, 0, 0, },  } }, .ops_count=2, /* DESCRIPTION=Repeat String Operation Prefix */ },
	{ .prefix=0xF2, .mnemonic="REP", .op={ {.reg="rCX", }, 0, 0, 0, }, /* DESCRIPTION=Repeat String Operation Prefix */ },
	{ .prefix=0xF2, /* mnemo - no mnemonic */.op={ 0, 0, 0, 0, }, /* DESCRIPTION=Scalar Double-precision Prefix */ },
	{ .prefix=0xF3, .ops=(struct instr_ops[2]){ { .mnemonic="REPZ", .op={ {.reg="rCX", }, 0, 0, 0, },  }, { .mnemonic="REPE", .op={ {.reg="rCX", }, 0, 0, 0, },  } }, .ops_count=2, /* DESCRIPTION=Repeat String Operation Prefix */ },
	{ .prefix=0xF3, .mnemonic="REP", .op={ {.reg="rCX", }, 0, 0, 0, }, /* DESCRIPTION=Repeat String Operation Prefix */ },
	...
	{ .opcode1=0xFF, .reg_op=2, .mnemonic="CALL", .op={ {.f=F_ADDR_E | F_OPERAND_Q, }, 0, 0, 0, }, /* DESCRIPTION=Call Procedure */ },
	...
	{ .opcode1=0xFF, .reg_op=4, .mnemonic="JMP", .op={ {.f=F_ADDR_E | F_OPERAND_Q, }, 0, 0, 0, }, /* DESCRIPTION=Jump */ },
	...
	{ .opcode1=0xFF, .reg_op=6, .mnemonic="PUSH", .op={ {.f=F_ADDR_E | F_OPERAND_VQ, }, 0, 0, 0, }, /* DESCRIPTION=Push Word, Doubleword or Quadword Onto the Stack */ },

	/*
	 * Two byte instructions
	 */

	{ .two_byte=true, .opcode1=0x00, .reg_op=0xb0, .ops=(struct instr_ops[2]){ { .mnemonic="SLDT", .op={ {.f=F_ADDR_M | F_OPERAND_W, }, {.v=NO}, 0, 0, },  }, { .mnemonic="SLDT", .op={ {.f=F_ADDR_R | F_OPERAND_VQP, }, {.v=NO}, 0, 0, },  } }, .ops_count=2, /* DESCRIPTION=Store Local Descriptor Table Register */ },
	{ .two_byte=true, .opcode1=0x00, .reg_op=1, .ops=(struct instr_ops[2]){ { .mnemonic="STR", .op={ {.f=F_ADDR_M | F_OPERAND_W, }, {.v=NO}, 0, 0, },  }, { .mnemonic="STR", .op={ {.f=F_ADDR_R | F_OPERAND_VQP, }, {.v=NO}, 0, 0, },  } }, .ops_count=2, /* DESCRIPTION=Store Task Register */ },
	{ .two_byte=true, .opcode1=0x00, .reg_op=2, .mnemonic="LLDT", .op={ {.v=NO}, {.f=F_ADDR_E | F_OPERAND_W, }, 0, 0, }, /* DESCRIPTION=Load Local Descriptor Table Register */ },
	{ .two_byte=true, .opcode1=0x00, .reg_op=3, .mnemonic="LTR", .op={ {.v=NO}, {.f=F_ADDR_E | F_OPERAND_W, }, 0, 0, }, /* DESCRIPTION=Load Task Register */ },
	{ .two_byte=true, .opcode1=0x00, .reg_op=4, .mnemonic="VERR", .op={ {.f=F_ADDR_E | F_OPERAND_W, }, 0, 0, 0, }, /* DESCRIPTION=Verify a Segment for Reading */ },
	{ .two_byte=true, .opcode1=0x00, .reg_op=5, .mnemonic="VERW", .op={ {.f=F_ADDR_E | F_OPERAND_W, }, 0, 0, 0, }, /* DESCRIPTION=Verify a Segment for Writing */ },
	...
	{ .two_byte=true, .opcode1=0x01, .opcode2=0xC1, .reg_op=0xb0, .mnemonic="VMCALL", .op={ 0, 0, 0, 0, }, /* DESCRIPTION=Call to VM Monitor */ },
	{ .two_byte=true, .opcode1=0x01, .opcode2=0xC2, .reg_op=0xb0, .mnemonic="VMLAUNCH", .op={ 0, 0, 0, 0, }, /* DESCRIPTION=Launch Virtual Machine */ },
	{ .two_byte=true, .opcode1=0x01, .opcode2=0xC3, .reg_op=0xb0, .mnemonic="VMRESUME", .op={ 0, 0, 0, 0, }, /* DESCRIPTION=Resume Virtual Machine */ },
	{ .two_byte=true, .opcode1=0x01, .opcode2=0xC4, .reg_op=0xb0, .mnemonic="VMXOFF", .op={ 0, 0, 0, 0, }, /* DESCRIPTION=Leave VMX Operation */ },
	...
	{ .two_byte=true, .opcode1=0x01, .opcode2=0xF8, .reg_op=7, .mnemonic="SWAPGS", .op={ {.reg="GS", }, {.v=REG_I_ANY}, 0, 0, }, /* DESCRIPTION=Swap GS Base Register */ },
	...
	{ .two_byte=true, .opcode1=0x02, .reg_op=F_MODRM, .ops=(struct instr_ops[2]){ { .mnemonic="LAR", .op={ {.f=F_ADDR_G | F_OPERAND_VQP, }, {.f=F_ADDR_M | F_OPERAND_W, }, 0, 0, },  }, { .mnemonic="LAR", .op={ {.f=F_ADDR_G | F_OPERAND_VQP, }, {.f=F_ADDR_R | F_OPERAND_V, }, 0, 0, },  } }, .ops_count=2, /* DESCRIPTION=Load Access Rights Byte */ },
	{ .two_byte=true, .opcode1=0x03, .reg_op=F_MODRM, .ops=(struct instr_ops[2]){ { .mnemonic="LSL", .op={ {.f=F_ADDR_G | F_OPERAND_VQP, }, {.f=F_ADDR_M | F_OPERAND_W, }, 0, 0, },  }, { .mnemonic="LSL", .op={ {.f=F_ADDR_G | F_OPERAND_VQP, }, {.f=F_ADDR_R | F_OPERAND_V, }, 0, 0, },  } }, .ops_count=2, /* DESCRIPTION=Load Segment Limit */ },
	{ .two_byte=true, .opcode1=0x05, .mnemonic="SYSCALL", .op={ {.reg="RCX", }, {.reg="R11", }, {.reg="SS", }, {.v=REG_ANY}, }, /* DESCRIPTION=Fast System Call */ },
	{ .two_byte=true, .opcode1=0x06, .mnemonic="CLTS", .op={ {.reg="CR0", }, 0, 0, 0, }, /* DESCRIPTION=Clear Task-Switched Flag in CR0 */ },
	{ .two_byte=true, .opcode1=0x07, .mnemonic="SYSRET", .op={ {.reg="SS", }, {.f=F_ADDR_F | F_OPERAND_D, }, {.reg="R11", }, {.v=REG_ANY}, }, /* DESCRIPTION=Return From Fast System Call */ },
	...
	{ .two_byte=true, .opcode1=0x20, .reg_op=F_MODRM, .mnemonic="MOV", .op={ {.f=F_ADDR_R | F_OPERAND_Q, }, {.f=F_ADDR_C | F_OPERAND_Q, }, 0, 0, }, /* DESCRIPTION=Move to/from Control Registers */ },
	{ .two_byte=true, .opcode1=0x20, .reg_op=F_MODRM, .mnemonic="MOV", .op={ {.f=F_ADDR_H | F_OPERAND_Q, }, {.f=F_ADDR_C | F_OPERAND_Q, }, 0, 0, }, /* DESCRIPTION=Move to/from Control Registers */ },
	{ .two_byte=true, .opcode1=0x21, .reg_op=F_MODRM, .mnemonic="MOV", .op={ {.f=F_ADDR_R | F_OPERAND_Q, }, {.f=F_ADDR_D | F_OPERAND_Q, }, 0, 0, }, /* DESCRIPTION=Move to/from Debug Registers */ },
	{ .two_byte=true, .opcode1=0x21, .reg_op=F_MODRM, .mnemonic="MOV", .op={ {.f=F_ADDR_H | F_OPERAND_Q, }, {.f=F_ADDR_D | F_OPERAND_Q, }, 0, 0, }, /* DESCRIPTION=Move to/from Debug Registers */ },
	{ .two_byte=true, .opcode1=0x22, .reg_op=F_MODRM, .mnemonic="MOV", .op={ {.f=F_ADDR_C | F_OPERAND_Q, }, {.f=F_ADDR_R | F_OPERAND_Q, }, 0, 0, }, /* DESCRIPTION=Move to/from Control Registers */ },
	{ .two_byte=true, .opcode1=0x22, .reg_op=F_MODRM, .mnemonic="MOV", .op={ {.f=F_ADDR_C | F_OPERAND_Q, }, {.f=F_ADDR_H | F_OPERAND_Q, }, 0, 0, }, /* DESCRIPTION=Move to/from Control Registers */ },
	{ .two_byte=true, .opcode1=0x23, .reg_op=F_MODRM, .mnemonic="MOV", .op={ {.f=F_ADDR_D | F_OPERAND_Q, }, {.f=F_ADDR_R | F_OPERAND_Q, }, 0, 0, }, /* DESCRIPTION=Move to/from Debug Registers */ },
	{ .two_byte=true, .opcode1=0x23, .reg_op=F_MODRM, .mnemonic="MOV", .op={ {.f=F_ADDR_D | F_OPERAND_Q, }, {.f=F_ADDR_H | F_OPERAND_Q, }, 0, 0, }, /* DESCRIPTION=Move to/from Debug Registers */ },
	...
	{ .two_byte=true, .opcode1=0x34, .mnemonic="SYSENTER", .op={ {.reg="SS", }, {.reg="RSP", }, {.v=REG_I_ANY}, {.v=REG_ANY}, }, /* DESCRIPTION=Fast System Call */ },
	{ .two_byte=true, .opcode1=0x35, .mnemonic="SYSEXIT", .op={ {.reg="SS", }, {.reg="eSP", }, {.v=REG_I_ANY}, {.v=REG_ANY}, }, /* DESCRIPTION=Fast Return from Fast System Call */ },
	{ .two_byte=true, .opcode1=0x37, .mnemonic="GETSEC", .op={ {.reg="EAX", }, 0, 0, 0, }, /* DESCRIPTION=GETSEC Leaf Functions */ },
	{ .prefix=0x66, .two_byte=true, .opcode1=0x38, .opcode2=0x80, .reg_op=F_MODRM, .mnemonic="INVEPT", .op={ {.f=F_ADDR_G | F_OPERAND_Q, }, {.f=F_ADDR_M | F_OPERAND_DQ, }, 0, 0, }, /* DESCRIPTION=Invalidate Translations Derived from EPT */ },
	{ .prefix=0x66, .two_byte=true, .opcode1=0x38, .opcode2=0x81, .reg_op=F_MODRM, .mnemonic="INVVPID", .op={ {.f=F_ADDR_G | F_OPERAND_Q, }, {.f=F_ADDR_M | F_OPERAND_DQ, }, 0, 0, }, /* DESCRIPTION=Invalidate Translations Based on VPID */ },
	...
	{ .two_byte=true, .opcode1=0x6E, .reg_op=F_MODRM, .ops=(struct instr_ops[2]){ { .mnemonic="MOVD", .op={ {.f=F_ADDR_P | F_OPERAND_Q, }, {.f=F_ADDR_E | F_OPERAND_D, }, 0, 0, },  }, { .mnemonic="MOVQ", .op={ {.f=F_ADDR_P | F_OPERAND_Q, }, {.f=F_ADDR_E | F_OPERAND_QP, }, 0, 0, },  } }, .ops_count=2, /* DESCRIPTION=Move Doubleword/Quadword */ },
	{ .prefix=0x66, .two_byte=true, .opcode1=0x6E, .reg_op=F_MODRM, .ops=(struct instr_ops[2]){ { .mnemonic="MOVD", .op={ {.f=F_ADDR_V | F_OPERAND_DQ, }, {.f=F_ADDR_E | F_OPERAND_D, }, 0, 0, },  }, { .mnemonic="MOVQ", .op={ {.f=F_ADDR_V | F_OPERAND_DQ, }, {.f=F_ADDR_E | F_OPERAND_QP, }, 0, 0, },  } }, .ops_count=2, /* DESCRIPTION=Move Doubleword/Quadword */ },
	...
	{ .two_byte=true, .opcode1=0x78, .reg_op=F_MODRM, .mnemonic="VMREAD", .op={ {.f=F_ADDR_E | F_OPERAND_Q, }, {.f=F_ADDR_G | F_OPERAND_Q, }, 0, 0, }, /* DESCRIPTION=Read Field from Virtual-Machine Control Structure */ },
	{ .two_byte=true, .opcode1=0x79, .reg_op=F_MODRM, .mnemonic="VMWRITE", .op={ {.f=F_ADDR_G | F_OPERAND_Q, }, {.f=F_ADDR_E | F_OPERAND_Q, }, 0, 0, }, /* DESCRIPTION=Write Field to Virtual-Machine Control Structure */ },
	...
	{ .two_byte=true, .opcode1=0x7E, .reg_op=F_MODRM, .ops=(struct instr_ops[2]){ { .mnemonic="MOVD", .op={ {.f=F_ADDR_E | F_OPERAND_D, }, {.f=F_ADDR_P | F_OPERAND_Q, }, 0, 0, },  }, { .mnemonic="MOVQ", .op={ {.f=F_ADDR_E | F_OPERAND_QP, }, {.f=F_ADDR_P | F_OPERAND_Q, }, 0, 0, },  } }, .ops_count=2, /* DESCRIPTION=Move Doubleword/Quadword */ },
	{ .prefix=0x66, .two_byte=true, .opcode1=0x7E, .reg_op=F_MODRM, .ops=(struct instr_ops[2]){ { .mnemonic="MOVD", .op={ {.f=F_ADDR_E | F_OPERAND_D, }, {.f=F_ADDR_V | F_OPERAND_DQ, }, 0, 0, },  }, { .mnemonic="MOVQ", .op={ {.f=F_ADDR_E | F_OPERAND_QP, }, {.f=F_ADDR_V | F_OPERAND_DQ, }, 0, 0, },  } }, .ops_count=2, /* DESCRIPTION=Move Doubleword/Quadword */ },
	...
	{ .two_byte=true, .opcode1=0xAA, .mnemonic="RSM", .op={ {.f=F_ADDR_F | F_OPERAND_W, }, 0, 0, 0, }, /* DESCRIPTION=Resume from System Management Mode */ },
	...
	{ .two_byte=true, .opcode1=0xAE, .reg_op=5, .mnemonic="XRSTOR", .op={ {.reg="ST", }, {.reg="ST1", }, {.reg="ST2", }, {.v=REG_ANY}, }, /* DESCRIPTION=Restore Processor Extended States */ },
	...
	{ .two_byte=true, .opcode1=0xC7, .reg_op=1, .x=X_LOCK, .ops=(struct instr_ops[2]){ { .mnemonic="CMPXCHG8B", .op={ {.f=F_ADDR_M | F_OPERAND_Q, }, {.reg="EAX", }, {.reg="EDX", }, {.v=REG_ANY}, },  }, { .mnemonic="CMPXCHG16B", .op={ {.f=F_ADDR_M | F_OPERAND_DQ, }, {.reg="RAX", }, {.reg="RDX", }, {.v=REG_ANY}, },  } }, .ops_count=2, /* DESCRIPTION=Compare and Exchange Bytes */ },
	{ .two_byte=true, .opcode1=0xC7, .reg_op=6, .mnemonic="VMPTRLD", .op={ {.f=F_ADDR_M | F_OPERAND_Q, }, 0, 0, 0, }, /* DESCRIPTION=Load Pointer to Virtual-Machine Control Structure */ },
	{ .prefix=0x66, .two_byte=true, .opcode1=0xC7, .reg_op=6, .mnemonic="VMCLEAR", .op={ {.f=F_ADDR_M | F_OPERAND_Q, }, 0, 0, 0, }, /* DESCRIPTION=Clear Virtual-Machine Control Structure */ },
	{ .prefix=0xF3, .two_byte=true, .opcode1=0xC7, .reg_op=6, .mnemonic="VMXON", .op={ {.f=F_ADDR_M | F_OPERAND_Q, }, 0, 0, 0, }, /* DESCRIPTION=Enter VMX Operation */ },
	{ .two_byte=true, .opcode1=0xC7, .reg_op=7, .mnemonic="VMPTRST", .op={ {.f=F_ADDR_M | F_OPERAND_Q, }, 0, 0, 0, }, /* DESCRIPTION=Store Pointer to Virtual-Machine Control Structure */ },
